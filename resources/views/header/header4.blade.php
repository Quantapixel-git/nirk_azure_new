                        ...
                        <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0 currency-visibility" id="currency-change">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                @foreach (get_all_active_currency() as $key => $currency)
                                    <li>
                                        <a class="dropdown-item text-dark @if ($system_currency->code == $currency->code) active @endif"
...
<header
    class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 violet-cart middle-background-color-visibility stikcy-header-visibility"
    ...
    <!-- Menu Bar -->
    <div class="d-none d-lg-block position-relative h-50px border-bottom bottom-background-color-visibility" style="background-color: {{ get_setting('bottom_header_bg_color') }}">
