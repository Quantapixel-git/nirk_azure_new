            ...
            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown ml-2 mb-1 z-1045 py-1">
                                    <button class="btn btn-link p-0 silder-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" class="top-text-color-visibility" style="color: {{$topHeaderTextColor}};">
                ...
                <div class="d-none d-xl-block ml-auto mr-0">
                    ...
                    <span class="d-flex align-items-center nav-user-info py-20px" {{-- @if (isAdmin()) ml-5 @endif --}}
                        ...
                        <!-- Name -->
                        <h4 class="h5 fs-14 fw-500 ml-2 mb-0 top-text-color-visibility" style="color: {{ $topHeaderTextColor }}">{{ $user->name }}</h4>
                    </span>
                    @else
                    <!--Login & Registration -->
                        ...
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="{{ route('logout') }}"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3 text-dark">{{ translate('Logout') }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
