        ...
        <div class="col-md-9">
            @foreach($order->orderDetails as $orderDetail)
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="font-weight-bold">{{ single_price($order->grand_total) }}</div>
        ...
        <div class="mt-2">
            ...
            @else
                ...
                <button
                    ...
                    data-return_date="{{ $returnValidTill->format('d M Y') }}"
                >
                    {{ translate('Return') }}
                </button>

                <small class="d-block text-muted mt-1">
                    {{ translate('Return valid till') }}
                    {{ $returnValidTill->format('d M Y') }}
                </small>
    ...
    @else
        ...
        <div class="mt-2">
            <span class="badge badge-secondary">
                {{ translate('Return Not Applicable') }}
            </span>
        </div>
