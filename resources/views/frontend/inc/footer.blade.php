        ...
        <div class="row no-gutters border-left border-soft-light">
            ...
            <div class="col-lg-3 col-6 policy-file">
                <a class="text-reset h-100  border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1" href="{{ route('terms') }}">
                    ...
                    <h4 class="text-dark fs-14 fw-700 mt-3">{{ translate('Terms Of Use') }}</h4>
                </a>
            </div>
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                          ...
                          <li class="mb-2">
                            <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('contact-us') }}">
                                {{ translate('Contact Us') }}
                            </a>
                        </li>
                          <li class="mb-2">
                            <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('about-us') }}">
                                {{ translate('About Us') }}
                            </a>
                        </li>
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        ...
                        <ul class="list-unstyled">
                            ...
                            @guest
                                ...
                                <li class="mb-2">
                                    <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('agent.login') }}">
                                        {{ translate('Agent Onboarding Panel') }}
                                    </a>
                                </li>
                            @endguest
