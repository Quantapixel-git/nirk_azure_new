...
<div class="mt-2 d-flex justify-content-center align-items-center">
    ...
    <button class="copy-btn ml-2"
        ...
        <img src="{{ asset('public/assets/img/copy.png') }}"
             alt="Copy"
             width="8">
    ...
    <button class="copy-btn ml-2"
        ...
        <img src="{{ asset('public/assets/img/share.png') }}"
             alt="Share"
             width="7">
    ...
    color:blueviolet;
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
    <a href="{{ route('mlm.userwallet') }}"
        class="aiz-side-nav-link {{ areActiveRoutes(['mlm.userwallet']) }}">
