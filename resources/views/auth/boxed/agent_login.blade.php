...
.site-logo img {
    ...
    <img src="{{ uploaded_asset(get_setting('site_icon')) }}"
         ...
         class="img-fluid">
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default loginForm" id="user-login-form"role="form" action="{{ route('agent.login.submit') }}" method="POST">
                                            @csrf
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a href="{{ route('agent.registration') }}" class="ml-2 fs-14 fw-700 animate-underline-primary">{{ translate('Register Now')}}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
