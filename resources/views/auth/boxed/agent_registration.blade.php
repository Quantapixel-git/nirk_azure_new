         ...
         class="img-fluid">
                            ...
                            <div class="py-5">
                                <div class="">
                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('agent.register') }}" method="POST">
                                        @csrf
                                        <!-- Name -->
                                        <div class="row">
                                ...
                                <p class="fs-12 text-gray mb-0">
                                    ...
                                    <a href="{{ route('agent.login') }}" class="ml-2 fs-14 fw-700 animate-underline-primary">{{ translate('Log In')}}</a>
                                </p>
                            </div>
                        </div>
                    </div>
