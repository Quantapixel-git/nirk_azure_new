...
@endcanany -->
    ...
    <ul class="aiz-side-nav-list level-2">
        ...
        <li class="aiz-side-nav-item">
            <a href="{{ route('mlm.wallet.history') }}"
               class="aiz-side-nav-link {{ areActiveRoutes(['mlm.wallet.history']) }}">
                <span class="aiz-side-nav-text">MLM Wallet History</span>
            </a>
        </li>

        <li class="aiz-side-nav-item">
            <a href="{{ route('mlm.user') }}"
               class="aiz-side-nav-link {{ areActiveRoutes(['mlm.user']) }}">
                <span class="aiz-side-nav-text">Manage MLM Users</span>
            </a>
        </li>
        
         <li class="aiz-side-nav-item">
            <a href="{{ route('mlm.withdrawals') }}"
               class="aiz-side-nav-link {{ areActiveRoutes(['mlm.withdrawals']) }}">
   ...
   {{-- Uploads Files --}}
            <li class="aiz-side-nav-item">
                <a href="{{ route('agent.targets') }}"
                    class="aiz-side-nav-link {{ areActiveRoutes(['agent.targets'])}}">
                    <div class="aiz-side-nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <g id="layer1" transform="translate(-0.53 -0.53)">
                                <path id="path3159"
                    ...
                    <span class="aiz-side-nav-text">{{ translate('Agent Target Configuration') }}</span>
                </a>
            </li>
            <!-- Addon Manager -->
             @can('manage_addons')
