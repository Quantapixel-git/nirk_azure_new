...
<input type="hidden" id="discounted_price">

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 0 Prize</label>
                                    <input type="text" name="level0" class="form-control" placeholder="Level 0 Prize">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 1 Prize</label>
                                    <input type="text" name="level1" class="form-control" placeholder="Level 1 Prize">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 2 Prize</label>
                                    <input type="text" name="level2" class="form-control" placeholder="Level 2 Prize">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 3 Prize</label>
                                    <input type="text" name="level3" class="form-control" placeholder="Level 3 Prize">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 4 Prize</label>
                                    <input type="text" name="level4" class="form-control" placeholder="Level 4 Prize">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 5 Prize</label>
                                    <input type="text" name="level5" class="form-control" placeholder="Level 5 Prize">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Level 6 Prize</label>
                                    <input type="text" name="level6" class="form-control" placeholder="Level 6 Prize">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function showProductSelectModal() {
        $('#products_select_modal').modal('show', {
            backdrop: 'static'
        });
...
$(document).ready(function () {
    ...
    function calculateMLMPercentage() {
        ...
        if (discountedPrice > 0) {
            mlmPercentage = (coins / discountedPrice) * 100;
        }

        $('#mlm_percentage').val(mlmPercentage.toFixed(2));
        $('#discounted_price').val(discountedPrice.toFixed(2));
    }

    $(document).on('keyup change input',
        '#coins, input[name="unit_price"], input[name="discount"], [name="discount_type"]',
