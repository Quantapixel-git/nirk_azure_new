...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2" style="background-color: rgb(255 255 255 / 90%)!important;">
    <div class="row align-items-center gutters-5">
        <!-- Dashboard -->
        <div class="col">
            <a href="<?php echo e(route('dashboard')); ?>" class="text-secondary d-block text-center pb-2 pt-3 <?php echo e(areActiveRoutes(['dashboard'],'svg-active')); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    <g id="Group_24768" data-name="Group 24768" transform="translate(3495.144 -602)">
                      <path id="Path_2916" data-name="Path 2916" d="M15.3,5.4,9.561.481A2,2,0,0,0,8.26,0H7.74a2,2,0,0,0-1.3.481L.7,5.4A2,2,0,0,0,0,6.92V14a2,2,0,0,0,2,2H14a2,2,0,0,0,2-2V6.92A2,2,0,0,0,15.3,5.4M10,15H6V9A1,1,0,0,1,7,8H9a1,1,0,0,1,1,1Zm5-1a1,1,0,0,1-1,1H11V9A2,2,0,0,0,9,7H7A2,2,0,0,0,5,9v6H2a1,1,0,0,1-1-1V6.92a1,1,0,0,1,.349-.76l5.74-4.92A1,1,0,0,1,7.74,1h.52a1,1,0,0,1,.651.24l5.74,4.92A1,1,0,0,1,15,6.92Z" transform="translate(-3495.144 602)" fill="#b5b5bf"/>
                    </g>
                </svg>
                <span class="d-block mt-1 fs-10 fw-600 text-reset <?php echo e(areActiveRoutes(['dashboard'],'text-primary')); ?>"><?php echo e(translate('Dashboard')); ?></span>
            </a>
        </div>

        <!-- My Delivery -->
        <div class="col">
            <a href="<?php echo e(route('completed-deliveries')); ?>" class="text-secondary d-block text-center pb-2 pt-3 <?php echo e(areActiveRoutes(['completed-deliveries'],'svg-active')); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                ...
                <span class="d-block mt-1 fs-10 fw-600 text-reset <?php echo e(areActiveRoutes(['completed-deliveries'],'text-primary')); ?>"><?php echo e(translate('My Delivery')); ?></span>
            </a>
        </div>

        <!-- My Earnings -->
        <div class="col">
            <a href="<?php echo e(route('total-earnings')); ?>" class="text-secondary d-block text-center pb-2 pt-3 <?php echo e(areActiveRoutes(['total-earnings'],'svg-active')); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                ...
                <span class="d-block mt-1 fs-10 fw-600 text-reset <?php echo e(areActiveRoutes(['total-earnings'],'text-primary')); ?>"><?php echo e(translate('My Earnings')); ?></span>
            </a>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/delivery_boys/inc/footer.blade.php ENDPATH**/ ?>