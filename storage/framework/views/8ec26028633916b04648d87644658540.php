         ...
         class="img-fluid">
                            ...
                            <div class="py-5">
                                <div class="">
                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="<?php echo e(route('agent.register')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <!-- Name -->
                                        <div class="row">
                                ...
                                <p class="fs-12 text-gray mb-0">
                                    ...
                                    <a href="<?php echo e(route('agent.login')); ?>" class="ml-2 fs-14 fw-700 animate-underline-primary"><?php echo e(translate('Log In')); ?></a>
                                </p>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layouts.authentication', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/auth/boxed/agent_registration.blade.php ENDPATH**/ ?>