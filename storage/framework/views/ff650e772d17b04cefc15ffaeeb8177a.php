    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-corner-8px">
            ...
            <div class="modal-body pt-3 pb-30px px-3 px-lg-5">
                ...
                <div>
                    <p class="fs-14 fw-200 text-dark text-center"><?php echo e(translate('Are you sure to delete those?')); ?></p>
                </div>
            </div>
            <!--Button-->
...
</div><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/modals/bulk_delete_modal.blade.php ENDPATH**/ ?>