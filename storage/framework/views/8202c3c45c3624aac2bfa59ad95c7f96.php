...
<div class="aiz-card-box h-auto bg-white py-3 hov-scale-img">
    <div class="position-relative h-100px h-md-200px img-fit overflow-hidden">
        ...
        ?>
        <!-- Image -->
        <a href="<?php echo e($product_url); ?>" class="d-block h-100 position-relative image-hover-effect">
            <img
        ...
        <?php if(discount_in_percentage($product) > 0): ?>
            <span class="absolute-top-left rounded rounded-4 bg-primary ml-1 mt-1 fs-11 fw-700 text-white w-35px text-center"
                style="padding-top:2px;padding-bottom:2px; top:<?php echo e(25 * $badgeIndex); ?>px;">-<?php echo e(discount_in_percentage($product)); ?>%</span>
            <?php $badgeIndex++; ?>
        <?php endif; ?>
        <!-- Wholesale tag -->
        <?php if($product->wholesale_product): ?>
            <span class="absolute-top-left rounded rounded-4 fs-11 text-white fw-700 px-2 lh-1-8 ml-1 mt-1"
                style="background-color: #455a64; <?php if(discount_in_percentage($product) > 0): ?> top:<?php echo e(25 * $badgeIndex); ?>px;"; <?php endif; ?>">
            ...
            <div class="d-sm-none position-absolute aiz-p-hov-icon-mobile"
                ...
                <div class="d-inline-flex px-2 py-1 shadow-sm">
                    ...
                    <a href="javascript:void(0)" class="hov-svg-white d-inline-block mb-2"
                        onclick="showAddToCartModal(<?php echo e($product->id); ?>)" data-toggle="tooltip"
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/thecore/partials/product_box_1.blade.php ENDPATH**/ ?>