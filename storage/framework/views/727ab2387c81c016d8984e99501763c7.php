        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="<?php echo e(route('dashboard')); ?>">
                        <?php
                ...
                <div class="ml-auto mr-0">
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info py-20px" id="nav-user-info">
                            ...
                            <span class="size-40px rounded-circle overflow-hidden border border-transparent nav-user-img">
                                <?php if(Auth::user()->avatar_original != null): ?>
                                    <img src="<?php echo e(uploaded_asset(Auth::user()->avatar_original)); ?>" class="img-fit h-100"
                    ...
                    <?php else: ?>
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info ml-3">
                            ...
                            <a href="<?php echo e(route('user.login')); ?>" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3"><?php echo e(translate('Login')); ?></a>
                            <a href="<?php echo e(route('user.registration')); ?>" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2"><?php echo e(translate('Registration')); ?></a>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="aiz-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('dashboard')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Dashboard')); ?></span>
                                </a>
                            </li>
                            
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('logout')); ?>" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                    ...
                                    <span class="user-top-menu-name text-primary has-transition ml-3"><?php echo e(translate('Logout')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/delivery_boys/inc/nav.blade.php ENDPATH**/ ?>