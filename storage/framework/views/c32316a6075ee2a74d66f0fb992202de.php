        ...
        <div class="modal-content rounded-corner-8px">
            ...
            <div class="modal-body pt-3 pb-30px px-3 px-lg-5">
                <div class="text-center pb-4">
                    ...
                    <h5 class="m-0 text-uppercase text-dark fs-20 fw-700 mt-4 pt-2" id="confirmation-title"><?php echo e(translate('Confirmation')); ?></h5>
                </div>
                <div>
            ...
            <!--Button-->
             <div class="d-flex align-items-center justify-content-between w-100 px-3 px-lg-5 pb-5 mb-3">
                ...
                <a href="javascript:void(0)" id="conform-yes-btn"
                    class="bg-transparent text-center border border-2 border-gray-400 rounded-2 fs-14 fw-700 py-15px text-danger d-block w-100"><?php echo e(translate('Yes')); ?></a>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/modals/bulk_action_modal.blade.php ENDPATH**/ ?>