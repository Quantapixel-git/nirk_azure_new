...
<div class="aiz-card-box h-auto bg-white py-3">
    <div class="position-relative h-100px h-md-200px img-fit overflow-hidden">
        ...
        ?>
        <!-- Image -->
        <a href="<?php echo e($product_url); ?>" class="d-block mx-auto w-100px w-sm-auto h-100 position-relative image-hover-effect rounded-2 ">
            <img
                class="lazyload mx-auto img-fit rounded-2 has-transition product-main-image"
                src="<?php echo e(get_image($product->thumbnail)); ?>"
        ...
        <?php if(discount_in_percentage($product) > 0): ?>
            <span class="absolute-top-left rounded rounded-4 bg-primary ml-1 mt-1 fs-11 fw-700 text-white w-35px text-center"
                style="padding-top:2px; padding-bottom:2px; top:<?php echo e(25 * $badgeIndex); ?>px;">
                -<?php echo e(discount_in_percentage($product)); ?>%
            </span>
            <?php $badgeIndex++; ?>
        <?php endif; ?>
        ...
        <?php if($product->wholesale_product): ?>
            <span class="absolute-top-left rounded rounded-4 fs-11 text-white fw-700 px-2 lh-1-8 ml-1 mt-1"
                style="background-color:#455a64; top:<?php echo e(25 * $badgeIndex); ?>px;">
        ...
        ?>
        <?php if($customLabels): ?>
            <?php $__currentLoopData = $customLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $customLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="absolute-top-left rounded rounded-4 fs-11 fw-700 px-2 lh-1-8 ml-1 mt-1"
                    style="background-color:<?php echo e($customLabel->background_color); ?>;
                        color:<?php echo e($customLabel->text_color); ?>;
                        top:<?php echo e(25 * $badgeIndex); ?>px;">
                    <?php echo e($customLabel->text); ?>
        ...
        <?php if($product->auction_product == 0): ?>
                ...
                <div class="d-inline-flex px-2 py-1 shadow-sm">
                    ...
                    <?php if( (is_array($colors) && count($colors) > 0) || (is_array($attributes) && count($attributes) > 0) ): ?>
                        <a href="javascript:void(0)" class="hov-svg-white d-inline-block mb-2"
                            onclick="showAddToCartRightCanvas(<?php echo e($product->id); ?>)" data-toggle="tooltip"
                            data-title="<?php echo e(translate('Select Variant')); ?>" data-placement="top">
                            <span><i class="las la-sliders-h d-block mt-2 text-gray hov-text-white" style="font-size: 1.4rem;"></i></span>
                        </a>
                    <?php else: ?>
                        <a href="javascript:void(0)" class="hov-svg-white d-inline-block mb-2"
                            <?php if(Auth::check() || get_Setting('guest_checkout_activation') == 1): ?> onclick="addToCartSingleProduct(<?php echo e($product->id); ?>)" <?php else: ?> onclick="showLoginModal()" <?php endif; ?> data-toggle="tooltip"
                            data-title="<?php echo e(translate('Add to Cart')); ?>" data-placement="top">
                    ...
                    <!-- Compare Icon -->
                    <a href="javascript:void(0)" class="hov-svg-white d-inline-block mb-2"
                        onclick="addToCompare(<?php echo e($product->id); ?>)" data-toggle="tooltip"
                        data-title="<?php echo e(translate('Add to compare')); ?>" data-placement="top">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <path
                                d="M18.037,5.547v.8a.8.8,0,0,1-.8.8H7.221a.4.4,0,0,0-.4.4V9.216a.642.642,0,0,1-1.1.454L2.456,6.4a.643.643,0,0,1,0-.909L5.723,2.227a.642.642,0,0,1,1.1.454V4.342a.4.4,0,0,0,.4.4H17.234a.8.8,0,0,1,.8.8Zm-3.685,4.86a.642.642,0,0,0-1.1.454v1.661a.4.4,0,0,1-.4.4H2.84a.8.8,0,0,0-.8.8v.8a.8.8,0,0,0,.8.8H12.854a.4.4,0,0,1,.4.4V17.4a.642.642,0,0,0,1.1.454l3.267-3.268a.643.643,0,0,0,0-.909Z"
                                transform="translate(-2.037 -2.038)" fill="#919199" />
                    ...
                    <a href="javascript:void(0)" class="hov-svg-white d-inline-block"
                        onclick="addToWishList(<?php echo e($product->id); ?>)" data-toggle="tooltip"
                        data-title="<?php echo e(translate('Add to wishlist')); ?>" data-placement="top">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.4" viewBox="0 0 16 14.4">
                            <g transform="translate(-3.05 -4.178)">
                                <path
                                    d="M11.3,5.507l-.247.246L10.8,5.506A4.538,4.538,0,1,0,4.38,11.919l.247.247,6.422,6.412,6.422-6.412.247-.247A4.538,4.538,0,1,0,11.3,5.507Z"
            ...
            <?php if( (is_array($colors) && count($colors) > 0) || (is_array($attributes) && count($attributes) > 0) ): ?>
                <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-none d-sm-flex flex-column justify-content-center align-items-center <?php if(in_array($product->id, $cart_added)): ?> active <?php endif; ?>"
                    href="javascript:void(0)" onclick="showAddToCartRightCanvas(<?php echo e($product->id); ?>)">
            ...
            <?php else: ?>
                <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-none d-sm-flex flex-column justify-content-center align-items-center <?php if(in_array($product->id, $cart_added)): ?> active <?php endif; ?>"
                    href="javascript:void(0)" <?php if(Auth::check() || get_Setting('guest_checkout_activation') == 1): ?> onclick="addToCartSingleProduct(<?php echo e($product->id); ?>)" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>>
                    <span class="cart-btn-text">
        ...
        <?php if(
            ...
            <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-flex flex-column justify-content-center align-items-center <?php if(in_array($product->id, $cart_added)): ?> active <?php endif; ?>"
                href="javascript:void(0)" onclick="bid_single_modal(<?php echo e($product->id); ?>, <?php echo e($min_bid_amount); ?>, <?php echo e($gst_rate); ?>)">
    ...
    <div class="p-2 p-md-3 text-left">
        ...
        <div class="fs-14 d-flex justify-content-center mt-3">
            <?php if($product->auction_product == 0): ?>
                ...
                <!-- price -->
                <div class="">
                    <span class="fw-700"><?php echo e(home_discounted_base_price($product)); ?></span>
                </div>
            <?php endif; ?>
            <?php if($product->auction_product == 1): ?>
                <!-- Bid Amount -->
                <div class="">
                    <span class="fw-700"><?php echo e(single_price($product->starting_bid)); ?></span>
                </div>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/thecore/partials/home_product_box.blade.php ENDPATH**/ ?>