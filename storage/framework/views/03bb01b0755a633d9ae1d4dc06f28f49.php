...
<header
    class="<?php if(get_setting('header_stikcy') == 'on'): ?> sticky-top <?php endif; ?> z-1020 top-background-color-visibility stikcy-header-visibility"
    style="background-color: <?php echo e(get_setting('top_header_bg_color')); ?>">
    <!-- Search Bar -->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="<?php echo e(route('home')); ?>">
                        ...
                        <img id="header-logo-preview" src="<?php echo e(uploaded_asset($header_logo)); ?>" alt="<?php echo e(env('APP_NAME')); ?>"
                            class="mw-100 h-30px h-md-40px" height="40">
                        <?php else: ?>
                        <img id="header-logo-preview" src="<?php echo e(static_asset('assets/img/logo.png')); ?>" alt="<?php echo e(env('APP_NAME')); ?>"
                            class="mw-100 h-30px h-md-40px" height="40">
                        <?php endif; ?>
                    </a>
                </div>
                            ...
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="search-input-box">
                                    <input type="text"
                                        ...
                                        id="search" name="keyword" <?php if(isset($query)): ?> value="<?php echo e($query); ?>" <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <ul class="list-inline mb-0 h-100 d-none d-xl-flex justify-content-end align-items-center">
                                    <li class="list-inline-item mb-2 dropdown">
                                        <a class="dropdown-toggle no-arrow fs-12" data-toggle="dropdown"
                                            ...
                                            aria-expanded="false" onclick="nonLinkableNotificationRead()" style="color: <?php echo e(get_setting('top_header_text_color')); ?>">
                                            <span class="d-inline-block fs-12">
                                                <span class="btn btn-topbar btn-circle btn-light p-0 d-flex justify-content-center align-items-center" data-toggle="tooltip" data-title="<?php echo e(translate('Notification')); ?>">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="size-35px mr-2">
                                                                ...
                                                                ?>
                                                                <img src="<?php echo e(uploaded_asset($notificationType->image)); ?>"
                                                            ...
                                                            <div>
                                                                ...
                                                                <?php if($isLinkable = true): ?>
                                                                <a
                                                                    href="<?php echo e(route('notification.read-and-redirect', encrypt($notification->id))); ?>">
                                                                    <?php endif; ?>
                                                                    <span
                                                                        class="fs-12 text-dark text-truncate-2"><?php echo $notifyContent; ?></span>
                                                                    <?php if($isLinkable = true): ?>
                                                                </a>
                                                                <?php endif; ?>
                                                            </div>
                                ...
                                <div class="dropdown ml-2 mb-1 z-1045 py-1">
                                    <button class="btn btn-link p-0 silder-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" class="top-text-color-visibility" style="color: <?php echo e($topHeaderTextColor); ?>;">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right py-0" style="min-width: 200px;">
                                        ...
                                        <div class="dropdown-submenu px-2 py-2 mt-1 ml-2 border-bottom border-soft-light lang-visibility hover-bg-light"
                                            ...
                                            <div class="form-control form-control-sm border-0 bg-transparent p-0 w-100 cursor-pointer hover-text-primary h-100 d-flex align-items-center justify-content-between"
                                                ...
                                                <span><?php echo e($system_language->name); ?></span>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right py-0 header-drop child-dropdown"
                                                ...
                                                <div class="px-2 py-1 border-bottom border-soft-light hover-bg-light">
                                                    <a href="javascript:void(0)" class="d-block text-dark"
                                                        ...
                                                        onclick="changeLanguage('<?php echo e($language->code); ?>')">
                                                        <img src="<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>"
                                                            data-src="<?php echo e(static_asset('assets/img/flags/' . $language->code . '.png')); ?>"
                                                            class="mr-1 lazyload" alt="<?php echo e($language->name); ?>" height="11">
                                        ...
                                        <div class="dropdown-submenu px-2 py-2 mt-1 ml-2 border-bottom border-soft-light hover-bg-light currency-visibility"
                                            ...
                                            <div class="form-control form-control-sm border-0 bg-transparent p-0 w-100 cursor-pointer hover-text-primary h-100 d-flex align-items-center justify-content-between"
                                                onclick="toggleChildDropdown(this, event)">
                                                <span><?php echo e($system_currency->name ?? ''); ?>

                                                    (<?php echo e($system_currency->symbol ?? ''); ?>)</span>
                                                <i class="la la-angle-right"></i>
                                            </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right py-0 header-drop child-dropdown"
                                                style="min-width: 200px; left: 100%; top: 1px!important; margin-top: -1px;">
                                                <?php $__currentLoopData = get_all_active_currency(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="px-2 py-1 border-bottom border-soft-light hover-bg-light">
                                                    <a href="javascript:void(0)" class="d-block text-dark"
                                                        data-currency="<?php echo e($currency->code); ?>"
                                                        onclick="changeCurrency('<?php echo e($currency->code); ?>')">
                                        ...
                                        <div>
                                            <a href="<?php echo e(route(get_setting('seller_registration_verify') === '1' ? 'shop-reg.verification' : 'shops.create')); ?>"
                                            ...
                                            <a href="<?php echo e(route('seller.login')); ?>"
                                                class="dropdown-item fs-13 py-2 px-3 hover-bg-light hover-text-primary border-bottom border-soft-light d-flex align-items-center"
                                                style="min-height: 40px;">
                                                <?php echo e(translate('Seller Login')); ?>
                                        ...
                                        <?php endif; ?>
                                        <!-- Become a Seller Links -->
                                        <div id="admin-helpline-preview" style="display: <?php echo e(get_setting('helpline_number') ? 'block' : 'none'); ?>;">
                                            <div class="helpline-container">
                                                <a class="dropdown-item fs-13 py-2 px-3 hover-bg-light hover-text-primary border-bottom border-soft-light d-flex align-items-center"
                                                    ...
                                                    <span class="helpline-label"><?php echo e(translate('Helpline')); ?>:</span>&nbsp;
                                                    <span class="helpline-number-preview"><?php echo e(get_setting('helpline_number')); ?></span>
                                                </a>
                                            </div>
                                        </div>
                                        <?php if(Auth::check() && auth()->user()->user_type == 'customer'): ?>
                                        <div>
                                            <a href="<?php echo e(route('compare')); ?>"
                                                ...
                                                (<?php echo e(count(Session::get('compare'))); ?>)
                                                <?php endif; ?>
                                            </a>
                                            <a href="<?php echo e(route('wishlists.index')); ?>"
                                                ...
                                                (<?php echo e($wishlistProductCount); ?>)
                                                <?php endif; ?>
                                                <?php endif; ?>
                                            </a>
                                        </div>
                ...
                <div class="d-none d-xl-block ml-auto mr-0">
                    ...
                    <span class="d-flex align-items-center nav-user-info py-20px" 
                        ...
                        <!-- Name -->
                        <h4 class="h5 fs-14 fw-500 ml-2 mb-0 top-text-color-visibility" style="color: <?php echo e($topHeaderTextColor); ?>"><?php echo e($user->name); ?></h4>
                    </span>
                    <?php else: ?>
                    <!--Login & Registration -->
                    <span class="d-flex align-items-center nav-user-info ml-3">
                        <!-- Image -->
                        <span
                            class="size-40px rounded-circle overflow-hidden border d-flex align-items-center justify-content-center nav-user-img top-text-color-visibility" style="color: <?php echo e($topHeaderTextColor); ?>">
                        ...
                        <a href="<?php echo e(route('user.login')); ?>"
                            class="opacity-60 hov-opacity-100 fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3 top-text-color-visibility" style="color: <?php echo e($topHeaderTextColor); ?>"><?php echo e(translate('Login')); ?></a>
                        <a href="<?php echo e(route('user.registration')); ?>"
                            class="opacity-60 hov-opacity-100 fs-12 d-inline-block py-2 pl-2 top-text-color-visibility" style="color: <?php echo e($topHeaderTextColor); ?>"><?php echo e(translate('Registration')); ?></a>
                    </span>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="position-static float-right">
                    <div class="aiz-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('preorder.order_list')); ?>"
                                    class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Preorder List')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('digital_purchase_history.index')); ?>"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Downloads')); ?></span>
                                </a>
                            </li>
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('conversations.index')); ?>"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Conversations')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('wallet.index')); ?>"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('My Wallet')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('support_ticket.index')); ?>"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3"><?php echo e(translate('Support Ticket')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('logout')); ?>"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3 text-dark"><?php echo e(translate('Logout')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <!-- Menu Bar -->
    <div class="d-none d-lg-block position-relative h-50px bottom-background-color-visibility border-bottom" style="background-color: <?php echo e(get_setting('bottom_header_bg_color')); ?>;box-shadow: 0 8px 8px rgba(0, 0, 0, 0.05);">
            ...
            <div class="d-flex h-100">
                ...
                <div class="d-xl-block all-category has-transition bg-black-10 rounded-1 mt-1 mb-1 mr-2" id="category-menu-bar">
                    <div class="h-100"
                        ...
                        <div class="d-flex align-items-center justify-content-between bottom-text-color-visibility" style="color: <?php echo e($bottomHeaderTextColor); ?>">
                        ...
                        <ul class="list-inline mb-0 pl-0 hor-swipe c-scrollbar-light">
                            ...
                            <li class="list-inline-item mr-0 animate-underline-white">
                                <a href="<?php echo e(json_decode(get_setting('header_menu_links'), true)[$key]); ?>"
                                    class="fs-13 px-3 py-3 d-inline-block fw-700 header_menu_links hov-bg-black-10 bottom-text-color-visibility <?php if(url()->current() == json_decode(get_setting('header_menu_links'), true)[$key]): ?> active <?php endif; ?>" style="color: <?php echo e($bottomHeaderTextColor); ?>">
...
</header><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/header/header6.blade.php ENDPATH**/ ?>