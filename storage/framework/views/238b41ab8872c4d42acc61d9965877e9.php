<?php if(get_setting('smart_bar_status') != 0): ?>
        ...
        <div id="smart-bar" class="fixed-bottom smart-bar smart-bar-mobile hidden"
                style="background-color: <?php echo e($bg_color); ?>; color: <?php echo e($text_color); ?>; padding: 0.8rem 1rem; <?php echo e($opacityStyle); ?>">
            ...
            <div class="container ">
                <div class="d-flex align-items-center justify-content-between" style="gap: 0.6rem;">
                    ...
                    <div class="d-none d-lg-inline flex-grow-1 overflow-hidden">
                        <h6 class="mb-0 text-truncate-1 mr-2" style="color: <?php echo e($text_color); ?>; font-size: 14px; font-weight:500;">
                    ...
                    <div class="flex-shrink-0 d-flex align-items-center" style="gap: 0.3rem;">
                        <div class="fs-16 fs-md-18 fw-700 d-block d-sm-none"
                            style="color: <?php echo e($text_color); ?>">
                        ...
                        <div class="d-none d-sm-flex align-items-center" style="gap: 0.3rem;">
                            <?php if(home_price($detailedProduct) != home_discounted_price($detailedProduct)): ?>
                                ...
                                <div class="text-center d-flex flex-wrap flex-md-nowrap" style="font-size: 14px; color: <?php echo e($text_color); ?>">
                                    <del class="opacity-70 d-block mx-2 flex-shrink-0"><?php echo e(home_price($detailedProduct)); ?></del>
                                    <span class="fw-600 d-block flex-shrink-0"><?php echo e(discount_in_percentage($detailedProduct)); ?>% OFF</span>
                                </div>
                            <?php else: ?>
                                <div class="fw-700" style="font-size: 20px; font-weight:700; color: <?php echo e($text_color); ?>">
                                    <?php echo e(home_discounted_price($detailedProduct)); ?>
                        ...
                        <?php if($detailedProduct->digital == 0): ?>
                            ...
                            <?php else: ?>
                                <?php if( (is_array($colors) && count($colors) > 0) || (is_array($attributes) && count($attributes) > 0) ): ?>
                                    ...
                                    class="btn py-1 py-sm-2 px-2 px-sm-4 mr-2 add-to-cart fw-600 rounded-0" style="background-color: <?php echo e($button_color); ?>; color: <?php echo e($button_text_color); ?>;"
                                    <?php if(Auth::check() || get_Setting('guest_checkout_activation')==1): ?> onclick="scrollToTopSection()" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>>
                                        
                                        <span class="d-none d-sm-inline"><?php echo e(translate('Select Variant')); ?></span>
                            ...
                            <button type="button" class="btn py-1 py-sm-2 px-2 px-sm-4 out-of-stock fw-600 d-none rounded-0" disabled style="background-color: <?php echo e($button_color); ?>; color: <?php echo e($button_text_color); ?>;">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        <a href="javascript:void(0)" onclick="closeSmartBar()">
                            <i style="color: <?php echo e($button_color); ?>;" class="la la-close la-2x"></i>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <?php endif; ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/smart_bar.blade.php ENDPATH**/ ?>