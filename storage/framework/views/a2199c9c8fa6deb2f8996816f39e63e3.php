...
<?php $__env->startSection('panel_content'); ?>
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3"><?php echo e(translate('Shop Settings')); ?>
                ...
                <span class="ml-3 fs-13">(<a href="<?php echo e(route('shop.visit', $shop->slug)); ?>" class="btn btn-link btn-sm px-0" target="_blank"><?php echo e(translate('Visit Shop')); ?> <i class="las la-arrow-right"></i></a>)</span>
            </h1>
        </div>
      </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="<?php echo e(route('seller.shop.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label><?php echo e(translate('Shop Phone')); ?> <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-10">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><?php echo e(translate('Business Settings')); ?></h5>
        </div>

        <div class="card-body">
            <form action="<?php echo e(route('seller.shop.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="shop_id" value="<?php echo e($shop->id); ?>">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>
                            <?php echo e(translate('GSTIN Number')); ?>

                            <span class="text-danger">*</span>
                        </label>
                    </div>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3"  name="gstin_number" placeholder="<?php echo e(translate('GSTIN Number')); ?>" value="<?php echo e($business_info['gstin'] ?? ''); ?>" required <?php if($shop->gst_verification): ?> disabled <?php endif; ?>>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>
                            <?php echo e(translate('GSTIN Certificate')); ?>
                    ...
                    <div class="col-md-10">
                        <div class="custom-file mb-3">
                            <label class="custom-file-label">
                                <input type="file" data-preview="#gst_preview" class="custom-file-input preview-input" name="gstin_certificate" id="gstin_certificate"  accept=".jpg,.jpeg,.png,.bmp,application/pdf" required <?php if($shop->gst_verification): ?> disabled <?php endif; ?>>
                                <span class="custom-file-name"><?php echo e(translate('Choose file')); ?></span>
                            </label>
                        </div>
                        <div id="gst_preview" class="mt-2"></div>
                        <?php if(isset($business_info['certificate'])): ?>
                        <div class="mb-2 text-center">
                            <a onclick="showFileInModal('<?php echo e(my_asset($business_info['gstin_certificate'])); ?>')" class="btn btn-sm btn-info text-white"><?php echo e(translate('View Current Certificate')); ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>
                            <?php echo e(translate('VAT / TIN / BIN Number')); ?>

                            <span class="text-danger">*</span>
                        </label>
                    </div>
                    <div class="col-md-10">
                        <input type="text"  class="form-control mb-3"  name="certificate_number" placeholder="<?php echo e(translate('VAT / TIN / BIN Number')); ?>" value="<?php echo e($business_info['certificate_number'] ?? ''); ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>
                            <?php echo e(translate('Reg Certificate / Trade License / Sale Tax Permit ')); ?>
                    ...
                    <div class="col-md-10">
                        ...
                        <?php if(isset($business_info['certificate'])): ?>
                        <div class="mb-2 text-center">
                            <a onclick="showFileInModal('<?php echo e(my_asset($business_info['certificate'])); ?>')" class="btn btn-sm btn-info text-white"><?php echo e(translate('View Current Certificate')); ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="col-md-10">
                        <div class="mb-3">
                            <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="<?php echo e(translate('Select your country')); ?>" name="country_id" required>
                                ...
                                <option value="<?php echo e($country->id); ?>" <?php if(isset($business_info['country']) && $business_info['country'] == $country->name): ?> selected <?php endif; ?>><?php echo e($country->name); ?> </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                </div>
                <?php elseif(get_active_countries()->count() == 1): ?>
                <input type="hidden" name="country_id" value="<?php echo e(get_active_countries()->first()->id); ?>">
                <?php endif; ?>
                <div class="row">
                    <div class="col-md-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="<?php echo e(route('seller.shop.banner.update')); ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="shop_id" value="<?php echo e($shop->id); ?>">
                <?php echo csrf_field(); ?>
                <!-- Top Banner -->
                <div class="row mb-3">
                    <label class="col-md-2 col-form-label"><?php echo e(translate('Top Banner')); ?> (1920x360)</label>
                    <div class="col-md-10">
                        <div class="row p-3 p-md-4 mb-3 mb-md-2rem mx-0" style="border: 1px dashed #e4e5eb;">
                            <div class="col-md-6">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount"><?php echo e(translate('Choose File')); ?></div>
                                    <input type="hidden" name="top_banner_image" value="<?php echo e($shop->top_banner_image); ?>" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control mb-3" placeholder="<?php echo e(translate('Top banner Link')); ?>" name="top_banner_link" value="<?php echo e($shop->top_banner_link); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Slider Banners -->
                <div class="row mb-3">
                    <label class="col-md-2 col-form-label"><?php echo e(translate('Slider Banners')); ?> (1500x450)</label>
                    <div class="col-md-10">
                        <div class="shop-slider-target">
                            <?php $slider_images = $shop->slider_images; ?>
                            <?php if($slider_images != null): ?>
                                <?php $__currentLoopData = json_decode($slider_images, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
                                        <div class="row gutters-5">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group mb-md-0">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount"><?php echo e(translate('Choose File')); ?></div>
                                                        <input type="hidden" name="slider_images[]" class="selected-files" value="<?php echo e(json_decode($slider_images, true)[$key]); ?>">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group mb-md-0">
                                                    <input type="text" class="form-control" placeholder="http://" name="slider_links[]" value="<?php echo e(isset(json_decode($shop->slider_links, true)[$key]) ? json_decode($shop->slider_links, true)[$key] : ''); ?>">
                                                </div>
                                            </div>
                ...
                <!-- Banner Full width 1 -->
                <div class="row mb-3">
                    <label class="col-md-2 col-form-label"><?php echo e(translate('Banner Full width 1')); ?></label>
                    <div class="col-md-10">
                        <div class="shop-banner-full-width-1">
                            <?php $banner_full_width_1_images =  $shop->banner_full_width_1_images; ?>
                            <?php if($banner_full_width_1_images != null): ?>
                                <?php $__currentLoopData = json_decode($banner_full_width_1_images, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
                                        <div class="row gutters-5">
                                            <!-- Image -->
                                            <div class="col-md-5">
                                                <div class="form-group mb-md-0">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount"><?php echo e(translate('Choose File')); ?></div>
                                                        <input type="hidden" name="banner_full_width_1_images[]" class="selected-files" value="<?php echo e(json_decode($banner_full_width_1_images, true)[$key]); ?>">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group mb-md-0">
                                                    <input type="text" class="form-control" placeholder="http://" name="banner_full_width_1_links[]" value="<?php echo e(isset(json_decode($shop->banner_full_width_1_links, true)[$key]) ? json_decode($shop->banner_full_width_1_links, true)[$key] : ''); ?>">
                                                </div>
                                            </div>
                                            <!-- remove parent button -->
                                            <div class="col-md-auto">
                ...
                <!-- Banners half width -->
                <?php $banners_half_width_images = $shop->banners_half_width_images; ?>
                <div class="row mb-3">
                    <label class="col-md-2 col-form-label"><?php echo e(translate('Banners half width')); ?> (<?php echo e(translate('2 Equal Banners')); ?>)</label>
                    <div class="col-md-10">
                        <div class="shop-banners-half-width">
                            <?php $banner_full_width_1_images =  $shop->banner_full_width_1_images; ?>
                            <?php if($banners_half_width_images != null): ?>
                                <?php $__currentLoopData = json_decode($banners_half_width_images, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
                                        <div class="row gutters-5">
                                            <!-- Image -->
                                            <div class="col-md-5">
                                                <div class="form-group mb-md-0">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount"><?php echo e(translate('Choose File')); ?></div>
                                                        <input type="hidden" name="banners_half_width_images[]" class="selected-files" value="<?php echo e(json_decode($banners_half_width_images, true)[$key]); ?>">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group mb-md-0">
                                                    <input type="text" 
                                                        ...
                                                        value="<?php echo e(isset(json_decode($shop->banners_half_width_links, true)[$key]) ? json_decode($shop->banners_half_width_links, true)[$key] : ''); ?>">
                                                </div>
                                            </div>
                                            <!-- remove parent button -->
                                            <div class="col-md-auto">
                ...
                <!-- Banner Full width 2 -->
                <?php $banner_full_width_2_images = $shop->banner_full_width_2_images; ?>
                <div class="row mb-3">
                    <label class="col-md-2 col-form-label"><?php echo e(translate('Banner Full width 2')); ?></label>
                    <div class="col-md-10">
                        <div class="shop-banner-full-width-2">
                            <?php $banner_full_width_1_images =  $shop->banner_full_width_1_images; ?>
                            <?php if($banner_full_width_2_images != null): ?>
                                <?php $__currentLoopData = json_decode($banner_full_width_2_images, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
                                        <div class="row gutters-5">
                                            <!-- Image -->
                                            <div class="col-md-5">
                                                <div class="form-group mb-md-0">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount"><?php echo e(translate('Choose File')); ?></div>
                                                        <input type="hidden" name="banner_full_width_2_images[]" class="selected-files" value="<?php echo e(json_decode($banner_full_width_2_images, true)[$key]); ?>">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group mb-md-0">
                                                    <input type="text" 
                                                        ...
                                                        value="<?php echo e(isset(json_decode($shop->banner_full_width_2_links, true)[$key]) ? json_decode($shop->banner_full_width_2_links, true)[$key] : ''); ?>">
                                                </div>
                                            </div>
                                            <!-- remove parent button -->
                                            <div class="col-md-auto">
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><?php echo e(translate('File Preview')); ?></h5>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php if(addon_is_activated('delivery_boy') && get_setting('google_map') == 1): ?>
            
    <script>
        function initialize(id_format = '') {
            let default_longtitude = '';
            let default_latitude = '';
            <?php if(get_setting('google_map_longtitude') != '' && get_setting('google_map_longtitude') != ''): ?>
                default_longtitude = <?php echo e(get_setting('google_map_longtitude')); ?>;
                default_latitude = <?php echo e(get_setting('google_map_latitude')); ?>;
            <?php endif; ?>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('MAP_API_KEY')); ?>&libraries=places&language=en&callback=initialize" async defer></script>
    ...
    function get_states(country_id) {
        var savedStateName = "<?php echo e(optional(json_decode($shop->business_info))->state ?? ''); ?>";
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/seller/shop.blade.php ENDPATH**/ ?>