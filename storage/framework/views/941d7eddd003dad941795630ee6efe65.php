...
<div class="aiz-titlebar text-left mt-2 mb-3 pb-2 border-bottom border-gray">
	<div class="row align-items-center">
		<div class="col">
			<h1 class="h3"><?php echo e(translate('Authentication Page Layout')); ?></h1>
		</div>
	</div>
</div>
			...
			<div class="row">
				...
				<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
					...
					<div class="d-flex flex-wrap justify-content-between align-items-center">
						<span class="fs-14 fw-500 text-dark"><?php echo e(translate('Authentication Layout 1 - Boxed')); ?></span>
						<span>
							<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
								onclick="imageShowOverlay('<?php echo e(static_asset('assets/img/authentication_pages/boxed.png')); ?>')"><?php echo e(translate('View')); ?></a>
						</span>
					</div>
				</div>
				...
				<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
					...
					<div class="d-flex flex-wrap justify-content-between align-items-center">
						<span class="fs-14 fw-500 text-dark"><?php echo e(translate('Authentication Layout 2 - Free')); ?></span>
						<span>
							<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
								onclick="imageShowOverlay('<?php echo e(static_asset('assets/img/authentication_pages/free.png')); ?>')"><?php echo e(translate('View')); ?></a>
						</span>
					</div>
				</div>
				...
				<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
					...
					<div class="d-flex flex-wrap justify-content-between align-items-center">
						<span class="fs-14 fw-500 text-dark"><?php echo e(translate('Authentication Layout 3 - Focused')); ?></span>
						<span>
							<a href="javascript:void(0);" class="btn btn-xs btn-danger rounded-0"
								onclick="imageShowOverlay('<?php echo e(static_asset('assets/img/authentication_pages/focused.png')); ?>')"><?php echo e(translate('View')); ?></a>
						</span>
					</div>
				</div>
			</div>
			<div class="row bg-light p-3 mt-5">
				<div class="col-md-8 d-none d-md-block">
					<div class="d-flex align-items-center">
						...
						<div>
							<h4 class="fs-16 text-secondary"><?php echo e(translate('Configure your authentication page layout')); ?></h4>
...
<div class="aiz-titlebar border-bottom border-gray mb-3 mt-2 mt-md-5 pb-2 text-left">
	<div class="row align-items-center">
		<div class="col">
			<h1 class="h3"><?php echo e(translate('Authentication Page Images')); ?></h1>
		</div>
	</div>
</div>
		...
		<form action="<?php echo e(route('business_settings.update')); ?>" method="POST">
			...
			<div class="row">
				...
				<div class="form-group col-lg-6">
					<label class="from-label fs-13"><?php echo e(translate('Admin login Page Image')); ?></label>
				...
				<div class="form-group col-lg-6">
					<label class="from-label fs-13"><?php echo e(translate('Customer Login page Image')); ?></label>
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						<div class="input-group-prepend">
							<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
						</div>
				...
				<div class="form-group col-lg-6">
					<label class="from-label fs-13"><?php echo e(translate('Customer Register Page Image')); ?></label>
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						<div class="input-group-prepend">
							<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
						</div>
				...
				<?php if(get_setting('vendor_system_activation') == 1): ?>
					...
					<div class="form-group col-lg-6">
						<label class="from-label fs-13"><?php echo e(translate('Seller Login Page Image')); ?></label>
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							<div class="input-group-prepend">
								<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
							</div>
					...
					<div class="form-group col-lg-6">
						<label class="from-label fs-13"><?php echo e(translate('Seller Register Page Image')); ?></label>
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							<div class="input-group-prepend">
								<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
							</div>
				...
				<?php if(addon_is_activated('delivery_boy')): ?>
					...
					<div class="form-group col-lg-6">
						<label class="from-label fs-13"><?php echo e(translate('Delivery Boy Login Page Image')); ?></label>
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							<div class="input-group-prepend">
								<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
							</div>
				...
				<div class="form-group col-lg-6">
					<label class="from-label fs-13"><?php echo e(translate('Forgot password')); ?></label>
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						<div class="input-group-prepend">
							<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
						</div>
				...
				<div class="form-group col-lg-6">
					<label class="from-label fs-13"><?php echo e(translate('Password Reset Page Image')); ?></label>
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						<div class="input-group-prepend">
							<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
						</div>
				...
				<?php if(addon_is_activated('otp_system')): ?>
					<div class="form-group col-lg-6">
						<label class="from-label fs-13"><?php echo e(translate('Phone Number Verification Page Image')); ?></label>
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							<div class="input-group-prepend">
								<div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
							</div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/backend/website_settings/authentication_layout_settings.blade.php ENDPATH**/ ?>