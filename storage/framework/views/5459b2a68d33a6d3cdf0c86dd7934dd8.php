...
<?php $__env->startSection('content'); ?>
    ...
    <div class="aiz-titlebar text-left pb-5px">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="h3 fw-bold"><?php echo e($order_types); ?></h1>
            </div>
         ...
         <div
            ...
            <div class="table-tabs-container flex-grow-1">
                <ul class="nav nav-tabs border-0 " id="myTab" role="tablist">
                    <?php $__currentLoopData = $seller_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link px-0 pb-15px fs-14 fw-500 <?php echo e($loop->first ? 'active' : ''); ?>"
                                ...
                                id="<?php echo e(Str::slug($seller_type)); ?>-tab"
                                onclick="changeTab(this, '<?php echo e(Str::slug($seller_type)); ?>')" role="tab"
                                aria-controls="<?php echo e(Str::slug($seller_type)); ?>">
                                <?php echo e(translate($seller_type)); ?>
                ...
                <div class="card-header row  border-0 pb-0 mt-2">
                    ...
                    <div class="dropdown mb-2 mb-md-0 bg-light mt-2 mt-md-0 px-md-1 rounded-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item confirm-alert text-secondary fs-14 fw-500 hov-bg-light hov-text-blue"
                                href="javascript:void(0)" id="order-bulk-export" onclick="order_bulk_export()"><?php echo e(translate('Export')); ?></a>
                            <?php endif; ?>
                            ...
                            <a class="dropdown-item text-secondary fs-14 fw-500 hov-bg-light hov-text-blue" id="bulk_unpaid_order_payment_notification"
                               href="javascript:void(0)" onclick="bulk_unpaid_order_payment_notification()"><?php echo e(translate('Unpaid Order Payment Notification')); ?></a>
                            <?php endif; ?>
                    ...
                    <div class="col-md-2 ml-auto mb-1 mb-md-0 px-0 px-md-1">
                        <div class="dropdown w-100">
                            <button
                                ...
                                aria-expanded="false">
                                <span class="text-secondary fs-14 fw-400"><?php echo e(translate('Filter By delivery Status')); ?></span>
                            ...
                            <div class="dropdown-menu py-3 w-100" aria-labelledby="filterMenu">
                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    ...
                                    <label class="form-check-label fs-14 px-2" for="all"><?php echo e(translate('All')); ?></label>
                                </div>
                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    <input class="input-check" type="checkbox" id="pending">
                                    <label class="form-check-label fs-14 px-2" for="pending"><?php echo e(translate('Pending')); ?></label>
                                </div>
                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    <input class="input-check" type="checkbox" id="confirmed">
                                    <label class="form-check-label fs-14 px-2" for="confirmed"><?php echo e(translate('Confirmed')); ?></label>
                                </div>
                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    <input class="input-check" type="checkbox" id="picked_up">
                                    <label class="form-check-label fs-14 px-2" for="picked_up"><?php echo e(translate('Picked Up')); ?></label>
                                </div>

                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    <input class="input-check" type="checkbox" id="on_the_way">
                                    <label class="form-check-label fs-14 px-2" for="on_the_way"><?php echo e(translate('On The Way')); ?></label>
                                </div>
                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    <input class="input-check" type="checkbox" id="delivered">
                                    <label class="form-check-label fs-14 px-2" for="delivered"> <?php echo e(translate('Delivered')); ?></label>
                                </div>
                                <div class="form-check hover-bg-light py-2 d-flex align-items-center">
                                    <input class="input-check" type="checkbox" id="cancelled">
                                    <label class="form-check-label fs-14 px-2" for="cancelled"> <?php echo e(translate('Cancel')); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 ml-auto pr-0 pr-md-1 pl-0 inner-select ">
                        <select class="form-control  aiz-selectpicker mb-2 mb-md-0 bg-light" name="payment_status"
                            ...
                            <option value="" class="hov-text-light text-white fs-14 fw-400"><?php echo e(translate('Filter by Payment Status')); ?></option>
                            <option value="payment_status,paid" class="hov-bg-light text-secondary fs-14 fw-40"
                                <?php if(isset($col_name, $query)): ?> <?php if($col_name == 'payment_status' && $query == 'paid'): ?> selected <?php endif; ?> <?php endif; ?>>
                                <?php echo e(translate('Paid')); ?></option>
                            <option value="payment_status,unpaid" class="hov-bg-light text-secondary fs-14 fw-40"
                                <?php if(isset($col_name, $query)): ?> <?php if($col_name == 'payment_status' && $query == 'unpaid'): ?> selected <?php endif; ?> <?php endif; ?>>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        let currentTab = '<?php echo e(Str::slug($seller_types[0] ?? '')); ?>';
        let searchTimer;
        ...
        function single_delete(orderId) {
            $.ajax({
                url: "<?php echo e(route('orders.destroy', ':id')); ?>".replace(':id', orderId),
                type: 'GET',
        ...
        function singleDelete(orderId) {
            ...
            $('#confirmation-question').text('<?php echo e(translate('Are you sure you want to delete this order?')); ?>');
            $('#impact-message').text('<?php echo e(translate('This action cannot be undone. Once deleted, the order will be permanently removed.')); ?>');
        ...
        function bulkDelete() {
            ...
            showBulkActionModal();
            $('#confirmation-title').text('<?php echo e(translate('Delete Confirmation')); ?>');
            $('#confirmation-question').text('<?php echo e(translate('Are you sure you want to delete the selected Orders?')); ?>');
            $('#impact-message').text('<?php echo e(translate('This action cannot be undone. Once deleted, the orders will be permanently removed.')); ?>');
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/backend/sales/index.blade.php ENDPATH**/ ?>