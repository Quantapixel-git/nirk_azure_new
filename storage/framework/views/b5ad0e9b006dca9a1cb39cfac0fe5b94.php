                        ...
                        <div class="aiz-carousel  arrow-inactive-transparent arrow-x-0 carousel-arrow"
                            ...
                            <div class="carousel-box hot-category-box mt-2 mt-md-1 mt-lg-2 mt-xl-3 mb-1 mb-md-0 mb-lg-1">
                                ...
                                <div class="fs-11 mr-1 mt-1 mt-lg-2 mt-xl-3 text-center " title="<?php echo e($category_name); ?>">
                                    <a href="<?php echo e(route('products.category', $category->slug)); ?>" class="fw-400 text-truncate-1 text-reset hov-text-primary"> <?php echo e($category_name); ?></a>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
            ...
            <div class="row pt-32px pb-26px">
                <div class="col-sm-6 col-md-4 col-lg-3 col-12 mb-3 mb-sm-0">
                    <div class="px-0 px-md-3">
                        ...
                        <p class="fs-13 fs-lg-14 fw-400 text-truncate-2" title="<?php echo e(translate('Categories catching eyes & winning hearts across our marketplace')); ?>"><?php echo e(translate('Categories catching eyes & winning hearts across our marketplace')); ?></p>
                    ...
                    <div class="aiz-carousel  arrow-inactive-transparent arrow-x-0  carousel-arrow"
                        ...
                        <div class="carousel-box">
                            ...
                            <div class="fs-11 mr-1 mt-3 text-center mt-2" title="<?php echo e($category_name); ?>">
                                <a class="fw-400 text-reset hov-text-primary" href="<?php echo e(route('products.category', $category->slug)); ?>"> <?php echo e(strlen($category_name) > 18 ? substr($category_name, 0,18).'...' : $category_name); ?></a>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <?php $__currentLoopData = $best_selling_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="px-3">
                            ...
                            <div class="fs-13 mr-sm-1 mt-3 text-center mt-2 px-xs-0 px-sm-4" title="<?php echo e($product->getTranslation('name')); ?>">
                                <a class="fw-400 text-truncate-2 hov-text-primary text-reset" href="<?php echo e(route('product', $product->slug)); ?>"><?php echo e($product->getTranslation('name')); ?></a>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/thecore/index.blade.php ENDPATH**/ ?>