                        ...
                        <div class="step-content active" id="step-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select" id="bank_name">
                                        ...
                                        <option value="State Bank of India"
                                            <?php echo e($kyc->bank_name == 'State Bank of India' ? 'selected' : ''); ?>>
                                            State Bank of India
                                        </option>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" value="<?php echo e($kyc->bank_holder); ?>" id="holder_name" class="form-control" placeholder="Enter Account Holder Name">
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label class="form-label">Bank Account Number</label>
                                    <input type="text" class="form-control" value="<?php echo e($kyc->bank_account); ?>" id="account_number" placeholder="Enter Account Number">
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label class="form-label">IFSC Code</label>
                                    <input type="text" class="form-control" value="<?php echo e($kyc->bank_ifsc); ?>" id="ifsc_code" placeholder="Enter IFSC Code">
                                </div>
                                <div class="col-md-6 mb-4">
           ...
           id="bank_passbook">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo e($kyc->phone); ?>" id="phone_number" placeholder="Enter Phone Number">
                                    </div>
                                </div>
...
<script>
    ...
    let currentStepFromBackend = <?php echo e($currentStep); ?>;
    let currentStep = 1; // Default to Step 1

    // Completed steps based on DB values
    let completedSteps = {
        1: <?php echo e($kyc->is_bank == 1 ? 'true' : 'false'); ?>,
        2: <?php echo e($kyc->is_aadhar == 1 ? 'true' : 'false'); ?>,
        3: <?php echo e($kyc->is_pan == 1 ? 'true' : 'false'); ?>
    ...
    $.ajax({
        url:"<?php echo e(route('save.bank.kyc')); ?>",
        type:"POST",
        data:formData,
        processData:false,
        contentType:false,
    ...
    $.ajax({
        url: "<?php echo e(route('save.aadhar.kyc')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
   ...
   function savePanStep() {
    ...
    $.ajax({
        url: "<?php echo e(route('save.pan.kyc')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/kyc/index.blade.php ENDPATH**/ ?>