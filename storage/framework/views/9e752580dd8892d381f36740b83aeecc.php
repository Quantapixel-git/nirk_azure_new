<div class="floating-buttons-section">
    ...
    <div class="aiz-floating-button">
        <a href="<?php echo e(route('categories.all')); ?>">
            ...
            <span class="text">
                <span class="w-120px mr-3"><?php echo e(translate('All Categories')); ?></span>
    ...
    <div class="aiz-floating-button">
        <a href="<?php echo e(route('flash-deals')); ?>">
            ...
            <span class="text">
                <span class="w-120px mr-3"><?php echo e(translate('Flash Sale')); ?></span>
                <svg xmlns="http://www.w3.org/2000/svg" width="7.073" height="12" viewBox="0 0 7.073 12">
                    <path id="Path_41557" data-name="Path 41557" d="M12.913,3.173,11.834,2.1,5.84,8.1l6,6,1.073-1.073L7.985,8.1Z" transform="translate(12.913 14.1) rotate(180)" fill="#fff"/>
                </svg>
            </span>
    ...
    <!-- Today's Deal -->
    <div class="aiz-floating-button">
        <a href="<?php echo e(route('todays-deal')); ?>">
            <span class="circle">
                <span class="">
            ...
            <span class="text">
                <span class="w-120px mr-3"><?php echo e(translate("Today's Deal")); ?></span>
                <svg xmlns="http://www.w3.org/2000/svg" width="7.073" height="12" viewBox="0 0 7.073 12">
                    <path id="Path_41557" data-name="Path 41557" d="M12.913,3.173,11.834,2.1,5.84,8.1l6,6,1.073-1.073L7.985,8.1Z" transform="translate(12.913 14.1) rotate(180)" fill="#fff"/>
                </svg>
            </span>
    ...
    <!-- Auction -->
    <div class="aiz-floating-button">
        <a href="<?php echo e(route('auction_products.all')); ?>">
            <span class="circle">
                <span class="">
            ...
            <span class="text">
                <span class="w-120px mr-3"><?php echo e(translate('Auction')); ?></span>
                <svg xmlns="http://www.w3.org/2000/svg" width="7.073" height="12" viewBox="0 0 7.073 12">
                    <path id="Path_41557" data-name="Path 41557" d="M12.913,3.173,11.834,2.1,5.84,8.1l6,6,1.073-1.073L7.985,8.1Z" transform="translate(12.913 14.1) rotate(180)" fill="#fff"/>
                </svg>
            </span>
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/inc/floating_buttons.blade.php ENDPATH**/ ?>