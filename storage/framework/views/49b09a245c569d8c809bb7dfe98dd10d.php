  <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="row align-items-center mb-3">
        ...
        <div class="col-md-9">
            <?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                        ...
                        <?php else: ?>
                            <div class="w-300px text-wrap">
                                <div class="font-weight-semibold fs-14 text-danger">
                                    <?php echo e(translate('Product deleted')); ?>
                    ...
                    <div class="col-md-4">
                        <div class="font-weight-bold"><?php echo e(single_price($order->grand_total)); ?></div>
        ...
        <div class="col-md-3 text-right d-none d-md-block align-self-start">
            <div>
             ...
             <?php
    $returnData = DB::table('product_mlm_prize')
        ->where('product_id', $orderDetail->product_id)
        ->first();

    $returnValidTill = null;
    ...
    if (
        ...
        $returnValidTill = \Carbon\Carbon::parse($order->delivered_date)
            ->addDays($returnData->return_days);
    }
...
<?php if(
    ...
    <?php if(now()->lte($returnValidTill)): ?>
        ...
        <div class="mt-2">
            ...
            <?php if($returnRequest): ?>
                ...
                <span class="btn btn-sm btn-warning rounded-pill">
            ...
            <?php else: ?>
                ...
                <button
                    class="btn btn-sm btn-danger rounded-pill return-btn"
                    data-order_id="<?php echo e($order->id); ?>"
                    data-order_detail_id="<?php echo e($orderDetail->id); ?>"
                    data-product_id="<?php echo e($orderDetail->product_id); ?>"
                    data-return_date="<?php echo e($returnValidTill->format('d M Y')); ?>"
                >
                    <?php echo e(translate('Return')); ?>
                ...
                <small class="d-block text-muted mt-1">
                    ...
                    <?php echo e($returnValidTill->format('d M Y')); ?>
    ...
    <?php else: ?>
        ...
        <div class="mt-2">
            <span class="badge badge-secondary">
                <?php echo e(translate('Return Not Applicable')); ?>
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/user/single_purchase_history.blade.php ENDPATH**/ ?>