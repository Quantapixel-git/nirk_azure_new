...
<div class="aiz-titlebar">
    <div class="row align-items-center">
        <div class="col-6">
            <h3 class="fs-20 fw-700 text-dark"><?php echo e(translate('Dashboard')); ?></h3>
        </div>
        <div class="col-6 text-right">
            <p class="fs-14 fw-400 text-dark mb-0"><?php echo e(date('d M, Y')); ?></p>
            <small class="fs-12 fw-400 text-secondary"><?php echo e(date('l')); ?></small>
        </div>
    </div>
</div>
...
<div class="row gutters-16">
    ...
    <div class="col-md-6 py-3">
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400"><?php echo e(translate('Completed Delivery')); ?></p>
                <h4 class="mb-0 fs-24 fw-700"><?php echo e(sprintf('%02d', $total_complete_delivery)); ?></h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 py-3">
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400"><?php echo e(translate('Pending Delivery')); ?></p>
                <h4 class="mb-0 fs-24 fw-700"><?php echo e(sprintf('%02d', $total_pending_delivery)); ?></h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 py-3">
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400"><?php echo e(translate('Total Collected')); ?></p>
                <h4 class="mb-0 fs-24 fw-700"><?php echo e($delivery_boy_info->total_collection); ?></h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 py-3">
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400"><?php echo e(translate('Earnings')); ?></p>
                <?php if(get_setting('delivery_boy_payment_type') == 'commission'): ?>
                    <h4 class="mb-0 fs-24 fw-700">
                        <?php echo e($delivery_boy_info->total_earning); ?>/
                        <span>
                            <small><?php echo e(translate('order')); ?></small>
                        </span>
                    </h4>
                <?php endif; ?>
                <?php if(get_setting('delivery_boy_payment_type') == 'salary'): ?>
                    <h4 class="mb-0 fs-24 fw-700">
                        <?php echo e(get_setting('delivery_boy_salary')); ?> / <?php echo e(translate('mo')); ?>
...
<div class="row gutters-16">
    ...
    <div class="col-lg-8 col-md-6 py-3">
        <div class="d-flex align-items-center p-4 bg-primary">
            ...
            <p class="mb-0 fs-14 fw-700 text-white ml-3"><?php echo e(translate('Cancelled Delivery')); ?></p>
            <h4 class="mb-0 fs-24 fw-700 text-white ml-3">
                <?php echo e(sprintf('%02d', $cancelled_deliveries)); ?>
    ...
    <div class="col-lg-4 col-md-6 py-3">
        <div class="d-flex align-items-center p-4 bg-soft-primary border border-primary">
            ...
            <a href="<?php echo e(route('cancel-request-list')); ?>" class="fs-14 fw-400 text-primary hov-text-primary ml-3 d-flex align-items-center animate-underline-primary">
                <span class="text-primary mr-3"><?php echo e(translate('Request to Cancel')); ?></span>
...
<div class="row gutters-16 mb-4">
    ...
    <div class="col-md-4 py-3">
        <a href="<?php echo e(route('on-the-way-deliveries')); ?>" class="d-flex flex-column align-items-center py-4 py-lg-5 border bg-light has-transition hov-bg-soft-light">
            ...
            <span class="mb-0 mt-3 fs-14 fw-700 text-primary"><?php echo e(translate('On The Way Deliveries')); ?></span>
        </a>
    </div>

    <!-- Picked Up Deliveries -->
    <div class="col-md-4 py-3">
        <a href="<?php echo e(route('pickup-deliveries')); ?>" class="d-flex flex-column align-items-center py-4 py-lg-5 border bg-light has-transition hov-bg-soft-light">
            ...
            <span class="mb-0 mt-3 fs-14 fw-700 text-warning"><?php echo e(translate('Picked Up Deliveries')); ?></span>
        </a>
    </div>

    <!-- Assigned Deliveries -->
    <div class="col-md-4 py-3">
        <a href="<?php echo e(route('assigned-deliveries')); ?>" class="d-flex flex-column align-items-center py-4 py-lg-5 border bg-light has-transition hov-bg-soft-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70">
            ...
            <span class="mb-0 mt-3 fs-14 fw-700" style="color: #0084b4;"><?php echo e(translate('Assigned Deliveries')); ?></span>
        </a>
    </div>
...
<?php echo $__env->make('delivery_boys.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/delivery_boys/dashboard.blade.php ENDPATH**/ ?>