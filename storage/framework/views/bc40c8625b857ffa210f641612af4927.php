<section id="reviewsRatings">
    <div class="reviews-ratings-container py-20px px-30px border bg-white border-light-gray rounded-2">
        <p class="fs-20 fw-bold text-dark"><?php echo e(translate('Reviews & Ratings')); ?></p>
        <!-- Reviews & Ratings Show -->
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
            <div class="d-flex flex-wrap align-items-center">
                <h4 class="my-0 mr-4 fs-48 fw-bold text-dark"><?php echo e(number_format($detailedProduct->rating, 1)); ?></h4>
                <div class="d-flex align-items-center">
                    ...
                    ?>
                    <p class="m-0 fs-14 fw-bold text-dark"><?php echo e(translate('Total Review')); ?> <span><?php echo e($total); ?></span></p>
                </div>
            </div>
            <div class="mt-3 mt-md-0">
                <button type="button" onclick="product_review('<?php echo e($detailedProduct->id); ?>', '<?php echo e($order_id ?? ''); ?>')"
                    ...
                    <span><?php echo e(translate('Rate this Product')); ?></span>
                    <span>
        ...
        <?php if($detailedProduct->reviews()->where('status', 1)->count() > 0): ?>
        <!-- Reviews & Ratings Show by Filter Start -->
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-2">
            <div>
                <span class="fs-14 fw-400 text-gray"><?php echo e(translate('Filter by Star Rating')); ?></span>
            ...
            <div class="w-100 w-md-auto">
                <label for="sortBy" class="fs-14 fw-400 text-gray d-block text-md-right"><?php echo e(translate('Sort by')); ?></label>
                <div class="custom-select-wrapper w-100">
                    <select class="aiz-selectpicker" id="sortBy" onchange="reviewBySort(this.value)"
                        ...
                        <option value="newest" selected class="cursor-pointer"><?php echo e(translate('Newest')); ?></option>
                        <option value="oldest" class="cursor-pointer"><?php echo e(translate('Oldest')); ?></option>
                        <option value="higest" class="cursor-pointer"><?php echo e(translate('Highest Rating')); ?></option>
                        <option value="lowest" class="cursor-pointer"><?php echo e(translate('Lowest Rating')); ?></option>
                    </select>
                </div>
            </div>
        </div>
        <?php else: ?>
            <div class="text-center">
                <h5 class="fs-16 fw-bold text-gray"><?php echo e(translate('No reviews found!')); ?></h5>
                <span>
        ...
        <!-- See More Button -->
         <?php if($detailedProduct->reviews()->count() > 3): ?>
         <div id="seeMoreReviews" >
            <div class="d-flex justify-content-end mt-3">
                <button type="button" id="see-more-btn" class="see-more-btn d-flex align-items-center px-30px py-10px fs-14 fw-400 text-blue bg-transparent bg-white border-0 hov-bg-blue has-transition hov-text-white rounded-pill" data-limit="0">
                    <span class="pr-1"><?php echo e(translate('See more')); ?></span>
                    <span>
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/product_details/review_section.blade.php ENDPATH**/ ?>