...
.site-logo img {
    ...
    <img src="<?php echo e(uploaded_asset(get_setting('site_icon'))); ?>"
         ...
         class="img-fluid">
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default loginForm" id="user-login-form"role="form" action="<?php echo e(route('agent.login.submit')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a href="<?php echo e(route('agent.registration')); ?>" class="ml-2 fs-14 fw-700 animate-underline-primary"><?php echo e(translate('Register Now')); ?></a>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layouts.authentication', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/auth/boxed/agent_login.blade.php ENDPATH**/ ?>