    ...
    <table class="table mb-0" id="aiz-data-table">
         <thead>
            <tr>
                ...
                <th class="hide-lg">#</th>
                <?php endif; ?>
                <th class="text-uppercase fs-10 fs-md-12 fw-700 text-secondary"><?php echo e(translate('Thumb')); ?></th>
                <th class="text-uppercase fs-10 fs-md-12 fw-700 text-secondary ml-1 ml-lg-0"><?php echo e(translate('Name / Brand')); ?></th>

                <th class="hide-xs text-uppercase fs-10 fs-md-12 fw-700 text-secondary"><?php echo e(translate('Owner / Category')); ?></th>
                <th class="hide-sm text-uppercase fs-12 fw-700 text-secondary"><?php echo e(translate('Ratings')); ?></th>
                <th class="hide-md text-uppercase fs-12 fw-700 text-secondary"> <?php echo e(translate('Price Details')); ?>

                </th>

                <?php if($ptoduct_type != 'pos_product_list'): ?>
                <th class="hide-xl text-uppercase fs-12 fw-700 text-secondary"><?php echo e(translate('Info')); ?></th>
                <th class="hide-xxl text-uppercase fs-12 fw-700 text-secondary"><?php echo e(translate('Published')); ?></th>
                <?php if(get_setting('product_approve_by_admin') == 1 && $type == 'seller'): ?>
                <th class="hide-xxl text-uppercase fs-12 fw-700 text-secondary"><?php echo e(translate('Approved')); ?></th>
                <?php endif; ?>

                <th class="hide-xxl text-uppercase fs-12 fw-700 text-secondary"><?php echo e(translate('Featured')); ?>

                </th>

                <th class="hide-xxl text-uppercase fs-12 fw-700 text-secondary"> <?php echo e(translate('Todays Deal')); ?></th>
                <?php endif; ?>
        ...
        <tbody>
            ...
            <tr class="data-row">
                ...
                <td class="align-middle w-40px">
                    ...
                    <?php else: ?>
                    <div class="form-group d-inline-block"><?php echo e($key + 1 + ($products->currentPage() - 1) * $products->perPage()); ?></div>
                    <?php endif; ?>
                </td>
                ...
                <td data-label="Thumb" class="w-60px w-md-80px w-md-100px">
                    <div class="w-40px h-40px w-sm-60px h-sm-60px w-md-80px h-md-80px rounded-2 overflow-hidden border">
                        <img src="<?php echo e(uploaded_asset($product->thumbnail_img)); ?>" alt="Image" class="img-fit">
                    </div>
                ...
                <td data-label="Name" class="w-lg-300px">
                    <div class="row gutters-5 w-sm-180px w-md-200px w-lg-100 mw-100 ml-1 ml-lg-0">
                        <div class="col">
                            <span class="text-truncate-2 fs-12 fs-md-14 fw-400 mr-2"><?php echo e($product->getTranslation('name')); ?></span>
                            <?php if(isset($product->brand->name)): ?>
                                <a href="<?php echo e(route('products.all', ['brand_id' => $product->brand->id, 'brand_name' => $product->brand->name])); ?>" class="fs-12 fs-md-14 fw-700 d-inline-block mt-1">
                                    <?php echo e(translate($product->brand->name)); ?>

                                </a>
                            <?php else: ?>
                                <span class="fs-12 fs-md-14 fw-700 d-inline-block mt-1 text-secondary"><?php echo e(translate('No Brand')); ?></span>
                            <?php endif; ?>
                ...
                <td class="hide-xs" data-label="Owner Category">
                     <?php $shop = optional(optional($product->user)->shop); ?>
                    <a href="<?php echo e($shop->id ? route('sellers.profile', encrypt($shop->id)) : '#'); ?>" class="fs-12 fs-md-14 fw-700 d-block">
                         <?php echo e($shop->name ?? translate('Inhouse')); ?>

                    </a>
                    <span class="fs-12 fw-200 text-secondary d-block pt-1"><?php echo e(translate('Main Category')); ?></span>
                    <p class="fs-12 fs-md-14 fw-700 m-0"><?php echo e(translate($product->main_category->name ?? '')); ?></p> 
                </td>
                <td class="hide-sm" data-label="Ratings">
                    <!--Ratting-->
                    <div class="d-flex align-items-center rattings">
                        <span class="rating rating-mr-1">
                            <?php echo e(renderStarRatingLatest($product->rating)); ?>

                        </span>
                    </div>
                    <p class="fs-14 m-0 py-1"><span class="fw-700"><?php echo e($product->rating); ?></span><span class="px-1"><?php echo e(translate('out of')); ?></span>
                        <span>5.0</span>
                    </p>
                    <?php
                        $total = 0;
                    ...
                    <p class="fs-14 fw-400 text-secondary m-0">
                        <span class="mr-1"><?php echo e($total); ?></span><?php echo e(translate('Reviews')); ?>
                ...
                <td class="hide-md align-middle" data-label="Price Details">
                    <div class="border-width-3  border-left border-blue px-2 py-0 mb-1">
                        <span class="text-secondary fs-12 fw-400"><?php echo e(translate('Price')); ?></span>
                        <p class="fs-16 fw-700 m-0"><?php echo e(single_price($product->unit_price)); ?></p>
                    </div>
                    <?php if(discount_in_percentage($product) > 0): ?>
                    <div class="border-width-3  border-left border-danger px-2 py-0">
                        <p class="fs-14 fw-400 m-0 py-5px"><?php echo e(translate('Discount')); ?>

                            <span class="text-danger fw-700 pl-1"><?php echo e(discount_in_percentage($product)); ?>%</span>
                        </p>
                    </div>
                    <?php endif; ?>
                </td>
                ...
                <td class="hide-xl" data-label="Info">
                    <span class="fs-12 fw-400 text-secondary"><?php echo e(('Number of Sale')); ?></span>
                    <p class="fs-16 fw-700 m-0 pb-10px"><?php echo e($product->num_of_sale); ?></p>
                    <?php if(!$product->draft && !$product->digital): ?>
                    <a href="javascript:void(0)" onclick='openRightcanvas(<?php echo e($product->id); ?>, "<?php echo e($product->getTranslation('name')); ?>" )'
                        class="fs-14 fw-300 text-blue td-see-more"><?php echo e(translate('View Stock')); ?></a>
                    <?php endif; ?>
                </td>
                ...
                <td class="hide-xxl align-middle" data-label="Published">
                    ...
                    <label class="aiz-switch aiz-switch-blue mb-0">
                        <input onchange="update_published(this)" value="<?php echo e($product->id); ?>"type="checkbox" <?php if ($product->published == 1) {
                                echo 'checked';
                            } ?>>
                    ...
                    <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                            <div class="table-options">
                                ...
                                <a href="<?php if($type == 'seller'): ?><?php echo e(route('products.seller.edit', ['id' => $product->id, 'lang' => env('DEFAULT_LANGUAGE')])); ?><?php else: ?><?php echo e(route('products.admin.edit', ['id' => $product->id, 'lang' => env('DEFAULT_LANGUAGE')])); ?><?php endif; ?>"
                                ...
                                <a href="<?php echo e(route('product', $product->slug)); ?>" target="_blank"
                                    ...
                                    <span class="fs-14 text-secondary fw-500 pl-10px"><?php echo e(translate('View Product')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php if($product->digital): ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_digital_product')): ?>
                                <a
                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue" href="<?php echo e(route('digitalproducts.download', encrypt($product->id))); ?>">
                                    <span>
                                    ...
                                    <span class="fs-14 text-secondary fw-500 pl-10px"><?php echo e(translate('Download')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php else: ?>
                                ...
                                <!--Make a Clone-->
                                <a
                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue" onclick="duplicateProduct(<?php echo e($product->id); ?>,'<?php echo e($type); ?>')">
                                    <span>
                                    ...
                                    <span class="fs-14 text-secondary fw-500 pl-10px"><?php echo e(translate('Make a Clone')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue" onclick="singleDelete(<?php echo e($product->id); ?>)">
                                    <span>
                                    ...
                                    <span class="fs-14 text-danger fw-500 pl-10px"><?php echo e(translate('Delete')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php else: ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pos_product_delete')): ?>
                                <!--Delete-->
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue text-nowrap" onclick="singleRemove(<?php echo e($product->id); ?>)">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10.667"
                                            height="12" viewBox="0 0 10.667 12">
                                            <path id="Path_45219" data-name="Path 45219"
                                    ...
                                    <span class="fs-14 text-danger fw-500 pl-5px"><?php echo e(translate('Remove from POS')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php endif; ?>
                            </div>
            ...
            <tr>
                <td colspan="11" class="text-center py-5">
                    <div class="w-100">
                        <h5 class="fs-16 fw-bold text-gray"><?php echo e(translate('No Products found!')); ?></h5>
...
</div><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/backend/product/products/products_table.blade.php ENDPATH**/ ?>