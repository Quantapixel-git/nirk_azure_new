<div class="col-sm-12 col-lg-6">
    <div class="d-flex align-items-center justify-content-end pb-20px right-side-cws">
        ...
        <?php if($detailedProduct->auction_product != 1): ?>
            <div>
                <button type="button" onclick="addToCompare(<?php echo e($detailedProduct->id); ?>)"
                    ...
                    <span class="ml-2 d-block compare"><?php echo e(translate('Compare')); ?></span>
                </button>
            </div>
            <div class="mx-3">
                <button type="button" onclick="addToWishList(<?php echo e($detailedProduct->id); ?>)"
                    class="p-0 d-flex align-items-center bg-transparent fs-12 fw-400 text-gray border-0 hov-text-dark has-transition">
                    <span>
                    ...
                    <span class="ml-2 d-block wishlist"><?php echo e(translate('Wishlist')); ?></span>
                </button>
            </div>
        <?php endif; ?>
        <div>
            <button type="button" data-toggle="modal" data-target="#social-share-modal"
                ...
                <span class="ml-2 d-block share"><?php echo e(translate('Share')); ?></span>
            </button>
        </div>
    </div>

    <h1 class="fs-20 fw-600 text-dark mb-3"><?php echo e($detailedProduct->getTranslation('name')); ?></h1>
    ...
    <div class="d-flex flex-wrap flex-column flex-sm-row align-items-sm-center justify-content-between">
        ...
        <?php if($detailedProduct->brand != null): ?>
            <div class="d-flex align-items-center">
                <span class="fs-14 fw-400 text-dark pr-2"><?php echo e(translate('Brand')); ?></span>
                <span class="fs-14 fw-400 text-blue"><a href="<?php echo e(route('products.brand', $detailedProduct->brand->slug)); ?>"><?php echo e($detailedProduct->brand->name); ?></a></span>
            </div>
        <?php endif; ?>
        <!--RIGHT-->
        <?php if(get_setting('product_query_activation') == 1): ?>
            <div class="">
                <a href="javascript:void();" onclick="goToView('product_query')"
                    ...
                    <span class="ml-2"><?php echo e(translate('Ask about this product')); ?></span>
                </a>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="d-flex flex-wrap flex-column flex-sm-row align-items-sm-center justify-content-between mt-2">
        ...
        <div class="d-flex align-items-center mb-2 mb-md-0">
            <div class="d-flex align-items-center pr-10px">
                <span class="rating rating-mr-2"><?php echo e(renderStarRating($detailedProduct->rating)); ?></span>
            </div>
            <div class="d-flex align-items-center total-rating-count">
                <span class="fs-14 text-dark fw-bold"><?php echo e($detailedProduct->rating); ?></span>
                <span class="fs-14 text-gray fw-400">/<?php echo e(translate('5.0')); ?></span>
                <span class="pl-5px fs-14 text-gray fw-400">(<?php echo e($total); ?> <?php echo e(translate('reviews')); ?>)</span>
            </div>
            
        </div>
        <?php if($detailedProduct->variant_product): ?>
            <!--RIGHT-->
            <div class="d-flex align-items-center mb-2 mb-md-0" id="variant_sku_section">
                <span class="fs-14 fw-400 text-gray"><?php echo e(translate('SKU')); ?></span>
        ...
        <?php elseif(($detailedProduct->stocks->first()->sku)): ?>
            <!--RIGHT-->
            <div class="d-flex align-items-center mb-2 mb-md-0" id="variant_sku_section">
                <span class="fs-14 fw-400 text-gray"><?php echo e(translate('SKU')); ?></span>
                <span class="fs-14 fw-500 text-dark ml-2 mr-2" id="variant_sku"><?php echo e(($detailedProduct->stocks->first()->sku)); ?></span>
                <button type="button" class="border-0 bg-transparent cursor-pointer sku-copy-btn" onclick="SKUCopyToClipboard()" data-url="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="13.6" height="16" viewBox="0 0 13.6 16">
                        <path id="Path_45213" data-name="Path 45213" d="M124.8-867.2a1.541,1.541,0,0,1-1.13-.47,1.541,1.541,0,0,1-.47-1.13v-9.6a1.541,1.541,0,0,1,.47-1.13,1.541,1.541,0,0,1,1.13-.47H132a1.541,1.541,0,0,1,1.13.47,1.541,1.541,0,0,1,.47,1.13v9.6a1.541,1.541,0,0,1-.47,1.13,1.541,1.541,0,0,1-1.13.47Zm0-1.6H132v-9.6h-7.2Zm-3.2,4.8a1.541,1.541,0,0,1-1.13-.47,1.541,1.541,0,0,1-.47-1.13v-11.2h1.6v11.2h8.8v1.6Zm3.2-4.8v0Z" transform="translate(-120 880)" fill="#919199"/>
                    </svg>
    ...
    <div class="d-flex flex-column align-items-start mt-3">
        ...
        <div class="d-flex align-items-center" id="live-product-viewing-visitors">
            ...
            <span class="fs-14 fw-400 text-dark"><?php echo e(translate('People are viewing right now')); ?></span>
        </div>
        <?php endif; ?>
        <div class="d-flex align-items-center">
            <?php if($detailedProduct->auction_product): ?>
                <span class="fs-14 fw-400 text-gray"><?php echo e(translate('Bided')); ?></span>
                <span class="fs-14 fw-bold text-dark ml-2"><?php echo e($detailedProduct->bids()->count()); ?></span>
            <?php else: ?>
    ...
    <!--Todays Deal Start-->
    <div class="mt-4 mb-3">
        <?php if($detailedProduct->todays_deal): ?>
            <div class="bg-dark py-10px px-20px rounded-corner-8px d-flex flex-wrap align-items-center justify-content-between">
                <span class="fs-14 fw-bold text-orange"><?php echo e(translate('Todays Deal')); ?></span>
                <span class="fs-14 fw-semibold text-orange"><?php echo e(translate('Exclusive for today only')); ?></span>
            </div>
        <?php endif; ?>
        <!--Todays Deal End-->
        ...
        <?php if($flashDealnotEnd): ?>
            <div id="flashSaleBox" class="flash-sale py-10px px-20px rounded-corner-8px d-flex flex-wrap align-items-center justify-content-between mt-2">
                <div>
                    ...
                    <span class="fs-14 fw-bold text-white text-uppercase ml-1"><?php echo e(translate('Flash Sale')); ?></span>
                </div>
                <!-- Countdown: ISO 8601 UTC string -->
                <span class="fs-14 fw-400 text-white flashSaleCountdown" data-end-date="<?php echo e(date('Y/m/d H:i:s', $flashDealEndDate)); ?>"><?php echo e(translate('Loading...')); ?></span>
            </div>
        <?php endif; ?>
    </div>
    <!--Flash Sale End-->
    ...
    <?php if($detailedProduct->auction_product): ?>
        ...
        <div class="py-10px px-20px border border-light-gray rounded-2 mt-4">
            <div class="border-bottom-dashed pt-2 pb-3">
                <p class="mb-1 fs-14 fw-bold text-dark"><?php echo e(translate('Auction Status')); ?></p>
                <div class="d-flex flex-wrap align-items-center">
                    <div class="mr-2">
                        <div class="text-dark fs-14 fw-400"><?php echo e(translate('Auction Will End')); ?></div>
                    </div>
                    <div class="">
                        <?php if($detailedProduct->auction_end_date > strtotime('now')): ?>
                            <div class="aiz-count-down align-items-center" data-date="<?php echo e(date('Y/m/d H:i:s', $detailedProduct->auction_end_date)); ?>"></div>
                        <?php else: ?>
                            <p class="m-0 text-dark fs-14 fw-400"><?php echo e(translate('Ended')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="border-bottom-dashed py-3">
                <div class="mb-1 fs-14 fw-bold text-dark"><?php echo e(translate('Starting Bid')); ?></div>
                <div class="">
                    <span class="text-dark fs-20 fw-400"><?php echo e(single_price($detailedProduct->starting_bid)); ?></span>
                    <?php if($detailedProduct->unit != null): ?>
                        <span class="text-secondary fs-14 fw-400">/<?php echo e($detailedProduct->getTranslation('unit')); ?></span>
                    <?php endif; ?>
                </div>
            </div>

            <div class="pt-3 pb-2">
                <div class="mb-1 fs-14 fw-bold text-dark"><?php echo e(translate('Highest Bid')); ?></div>
                <div class="">
        ...
        <?php if($detailedProduct->auction_end_date >= strtotime('now')): ?>
            <div class="mt-4">
                <?php if(Auth::check() && $detailedProduct->user_id == Auth::user()->id): ?>
                    <span class="bg-danger text-white text-center border-0 rounded-1 fs-12 py-10px px-10px d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2"><?php echo e(translate('Seller cannot Place Bid to His Own Product')); ?></span>
                <?php else: ?>
        ...
        <?php if($detailedProduct->est_shipping_days): ?>
            <div class="d-flex flex-wrap align-items-center mt-3">
                <p class="my-0 ml-0 mr-4 mr-md-4 mr-lg-5 fs-14 fw-400 text-black"><?php echo e(translate('Estimate Shipping Time')); ?> <span class="fw-bold ml-2"><?php echo e($detailedProduct->est_shipping_days); ?> <?php echo e(translate('Days')); ?></span></p>
            </div>
        <?php endif; ?>
        <div class="py-20px d-flex flex-wrap flex-xl-nowrap align-items-center">
            <div class="d-flex align-items-center bg-light p-20px rounded-2 w-100 mb-2 mb-xl-0 mr-0 mr-xl-2">
                <div class="store-logo-container w-48px h-48px bg-white border bordre-2 border-gray rounded-1 overflow-hidden mr-3 d-flex flex-shrink-0 align-items-center justify-content-center">
                    <img src="<?php echo e(uploaded_asset($seller_logo)); ?>" alt="seller">
                </div>
                <div>
                    <?php if($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1): ?>
                        <p class="m-0 fs-14">
                            <span class="fw-400 text-gray"><?php echo e(translate('Sold by')); ?></span>
                            <a href="<?php echo e(route('shop.visit', $detailedProduct->user->shop->slug)); ?>" class="fw-bold text-blue ml-2"><?php echo e($detailedProduct->user->shop->name); ?></a>
                        </p>
                    <?php else: ?>
                        <p class="m-0 fs-14">
                            <span class="fw-bold text-blue"><?php echo e(translate('Inhouse product')); ?></span>
                        </p>
                    <?php endif; ?>
                    <?php if(get_setting('conversation_system') == 1): ?>
                        <a href="javascript:void();" onclick="show_chat_modal()" class="fs-14 fw-400 text-blue animate-underline-blue has-transition"><?php echo e(translate('Message Seller')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            <?php if($detailedProduct->brand != null): ?>
                <div class="d-flex align-items-center bg-light p-20px rounded-2 w-100">
                    <div class="store-logo-container w-48px h-48px bg-white border bordre-2 border-gray rounded-1 overflow-hidden mr-3 d-flex flex-shrink-0 align-items-center justify-content-center">
                        <img src="<?php echo e(uploaded_asset($detailedProduct->brand->logo)); ?>"alt="<?php echo e($detailedProduct->brand->name); ?>" class="img-fit">
                    </div>
                    <div>
                        <p class="m-0 fs-14">
                            <span class="fw-400 text-gray"><?php echo e(translate('Brand')); ?></span>
                            <span class="fw-bold text-dark pl-5px"><?php echo e($detailedProduct->brand->name); ?></span>
                        </p>
                        <a href="<?php echo e(route('products.brand', $detailedProduct->brand->slug)); ?>" class="fs-14 fw-400 text-blue animate-underline-blue has-transition"><?php echo e(translate('Products from this brand')); ?></a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="warranty-section pb-20px">
            <ul class="m-0 p-0">
                <?php if($detailedProduct->cash_on_delivery): ?>
                    <li class="d-flex align-items-center">
                        <span class="d-block flex-shrink-0">
                            <img src="<?php echo e(static_asset('/assets/img/warranty-check-circle.svg')); ?>" alt="warranty check circle">
                        </span>
                        <span class="d-block pl-10px pr-25px fs-14 fw-400 text-dark warranty-text"><?php echo e(translate('Cash on Delivery Available')); ?></span>
                    </li>
                <?php endif; ?>
                <?php if($detailedProduct->shipping_type == 'free'): ?>
                    <li class="d-flex align-items-center">
                        <span class="d-block flex-shrink-0">
                            <img src="<?php echo e(static_asset('/assets/img/warranty-check-circle.svg')); ?>" alt="warranty check circle">
                        </span>
                        <span class="d-block pl-10px pr-25px fs-14 fw-400 text-dark warranty-text"><?php echo e(translate('Free Shipping')); ?></span>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
    ...
    <?php else: ?>
        <form id="option-choice-form" class="product-details-page">
            ...
            <!--In Stock Start-->
            <h5 class="fs-16 fw-600 text-gray"><?php echo e(translate('Pricing')); ?></h5>
            <div class="bg-light overflow-hidden px-20px py-20px rounded-2">
                <?php if($detailedProduct->digital == 0): ?>
                    <div class="d-flex flex-wrap align-items-center mb-md-0">
                        <h6 class="m-0 fs-20 fw-600 text-dark"><?php echo e(home_discounted_price($detailedProduct)); ?>

                            <?php if($detailedProduct->unit != null): ?>
                                <span class="opacity-70 fs-16 fw-400">/<?php echo e($detailedProduct->getTranslation('unit')); ?></span>
                            <?php endif; ?>
                        </h6>
                        <?php if(home_price($detailedProduct) != home_discounted_price($detailedProduct)): ?>
                            <del class="m-0 fs-14 fw-400 text-gray px-3"><?php echo e(home_price($detailedProduct)); ?></del>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    <input type="hidden" name="quantity" value="1">
                    <div class="d-flex flex-wrap align-items-center mb-md-0">
                        <h6 class="m-0 fs-24 fw-bold fw-700 text-dark"><?php echo e(home_discounted_price($detailedProduct)); ?>
                ...
                <?php if(discount_in_percentage($detailedProduct) > 0 || (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)): ?>
                <div class="d-flex flex-wrap align-items-center py-5px">
                    <div class="d-flex flex-wrap align-items-center mb-2 mb-md-0">
                        <div class="d-flex align-items-center mt-2">
                            <?php if(discount_in_percentage($detailedProduct) > 0 && (home_price($detailedProduct) != home_discounted_price($detailedProduct))): ?>
                                <span class="fs-12 fw-bold text-white py-1 py-md-2 px-10px discount-badge rounded-1">-<?php echo e(discount_in_percentage($detailedProduct)); ?>%</span>
                            <?php endif; ?>
                            <?php if(addon_is_activated('club_point') && $detailedProduct->earn_point > 0): ?>
                                <span class="fs-12 fw-bold text-orange text-uppercase opacity-80 py-1 py-md-2 px-10px bg-soft-light rounded-1 ml-1"><?php echo e(translate('Club Point')); ?>: <?php echo e($detailedProduct->earn_point); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <?php if($detailedProduct->wholesale_product == 1): ?>
                ...
                <div class="py-10px px-15px bg-white border border-light-gray rounded-2 mt-4 mb-4">
                    <table class="table m-0 p-0">
                        <thead>
                            <tr>
                                <th class="border-top-0 fs-14 fw-bold text-dark"><?php echo e(translate('Min Qty')); ?></th>
                                <th class="border-top-0 fs-14 fw-bold text-dark"><?php echo e(translate('Max Qty')); ?></th>
                                <th class="border-top-0 fs-14 fw-bold text-dark"><?php echo e(translate('Unit Price')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <?php if($detailedProduct->variant_product): ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4 mb-2">
                        <div class="d-inline-flex align-items-center">
                            <h5 class="fs-16 fw-600 text-gray mr-2 mb-0"><?php echo e(translate('Variation')); ?></h5>
                            <span>
                        ...
                        <?php if($sizeChartId != 0): ?>
                            <div>
                                <button type="button" onclick='showSizeChartDetail(<?php echo e($sizeChartId); ?>, "<?php echo e($sizeChartName); ?>")' class="fs-14 fw-400 text-blue border-0 bg-transparent d-flex align-items-center hov-opacity-80 has-transition">
                                    <span>
                                    ...
                                    <span class="pl-1"><?php echo e(translate('Size Guide')); ?></span>
                                </button>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="px-20px py-10px border border-soft-light rounded-2 product-variant position-relative collapsed">
                        ...
                        <?php if($detailedProduct->choice_options != null): ?>
                            <?php $__currentLoopData = json_decode($detailedProduct->choice_options); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $choice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="py-10px <?php echo e($key == 0 ? '' : 'variant-item'); ?> <?php echo e($key <9 ? '' : 'variant-item-none'); ?>">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <p class="m-0 fs-14 fw-bold text-dark"><?php echo e(get_single_attribute_name($choice->attribute_id)); ?></p>
                                    </div>
                                    <div class="variant-wrapper">
                                        <?php $__currentLoopData = $choice->values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="rounded-1 bg-white cursor-pointer aiz-megabox mb-1">
                                                <input type="radio" name="attribute_id_<?php echo e($choice->attribute_id); ?>" value="<?php echo e($value); ?>" <?php if($key == 0): ?> checked <?php endif; ?>>
                                                <div class="variant-item-select aiz-megabox-elem px-10px">
                                                    <span class="fs-14 fw-400 text-dark px-15px"><?php echo e($value); ?></span>
                                                </div>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                        ...
                        <?php if($detailedProduct->colors != null && count(json_decode($detailedProduct->colors)) > 0): ?>
                            <div class="py-10px  <?php echo e($product_variations>1 ? 'variant-item':''); ?>">
                                <p class="mb-3 fs-14 fw-bold text-dark"><?php echo e(translate('Color')); ?></p>
                                <div class="variant-wrapper">
                                    <?php $__currentLoopData = json_decode($detailedProduct->colors); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="aiz-megabox rounded-1 bg-white cursor-pointer" data-title="<?php echo e(get_single_color_name($color)); ?>">
                                            <input type="radio" name="color" value="<?php echo e(get_single_color_name($color)); ?>" <?php if($key == 0): ?> checked <?php endif; ?>>
                                            <div class="d-flex align-items-center variant-item-select aiz-megabox-elem px-15px">
                                                <span class="w-15px h-15px rounded-circle" style="background-color: <?php echo e($color); ?>;"></span>
                                                <span class="fs-14 fw-400 text-dark pl-2"><?php echo e(get_single_color_name($color)); ?></span>
                                            </div>
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                        ...
                        <?php endif; ?>
                        <!-- Toggle Button -->
                        <?php if($product_variations > 10): ?>
                            <button type="button" id="toggleHeight" class="d-flex align-items-center justify-content-center pt-10px pb-10px w-100 rounded-1 mb-2 fs-12 text-blue fw-400 has-transition border-0 more-toggle-btn" data-more="<?php echo e(translate('View More')); ?>" data-less="<?php echo e(translate('See Less')); ?>">
            ...
            <?php if(((get_setting('product_external_link_for_seller') == 1) && ($detailedProduct->added_by == "seller") && ($detailedProduct->external_link != null)) || (($detailedProduct->added_by != "seller") && ($detailedProduct->external_link != null))): ?>
            <?php else: ?>
                        ...
                        <div>
                            ...
                            <?php if($detailedProduct->digital ==0): ?>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="m-0 fs-14 fw-400 text-gray"><?php echo e(translate('Minimum order qty')); ?> <span class="text-dark fw-700"><?php echo e($detailedProduct->min_qty); ?></span></p>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div>
                            ...
                            <?php if($detailedProduct->digital ==0): ?>
                                <div class="d-flex align-items-center flex-wrap">
                                    <span class="fs-14 fw-400 text-gray pr-20px"><?php echo e(translate('QTY')); ?></span>
                                    <div class="d-flex align-items-center aiz-plus-minus border border border-soft-light rounded-1">
                                        ...
                                        <input type="number" value="<?php echo e($detailedProduct->min_qty); ?>" name="quantity" min="<?php echo e($detailedProduct->min_qty ?? 1); ?>" placeholder="1" max="10" lang="en" class="fs-16 text-dark fw-600 text-center w-40px h-100 mt-1 border-0 mx-2 input-number">
                                        <!--Incrrement-->
                            ...
                            <?php endif; ?>
                            <?php if(get_setting('whatsapp_order') == 1): ?>
                                <?php
                                ...
                                ?>
                                <?php if(($detailedProduct->added_by == 'seller' && get_setting('whatsapp_order_seller_prods') == 1) || ($detailedProduct->added_by == 'admin')): ?>
                                    <div class="order-via-whatsapp mt-2 text-right">
                                        <a href="<?php echo e($whatsappUrl); ?>" target="_blank" class="d-inline-flex align-items-center animate-underline-green has-transition">
                                            <i class="lab la-whatsapp fs-20"></i>
                                            <span class="fs-14 fw-400 pl-1"><?php echo e(translate('Order Via WhatsApp')); ?></span>
                                        </a>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <?php if($detailedProduct->variant_product): ?>
                        <div class="selected-variations border-top-dashed pt-10px pb-20px">
                            <p class="mb-2 fs-14 fw-semibold text-dark d-flex align-items-center">
                                ...
                                <span class="d-block mt-1 ml-2"><?php echo e(translate('Selected Product Summery')); ?></span>
                            </p>
                            <span class="fs-14 fw-400 text-gray"><?php echo e(strlen($detailedProduct->getTranslation('name')) > 120
                                        ? substr($detailedProduct->getTranslation('name'), 0, 120).'...'
                                        : $detailedProduct->getTranslation('name')); ?> - <span id="selected_variant"></span></span>
                        </div>
                    <?php endif; ?>
                    <!--Buttons Start-->
                    <div class="d-flex flex-wrap flex-md-nowrap align-items-center">
                        <button type="button" <?php if(Auth::check() || get_Setting('guest_checkout_activation')==1): ?> onclick="buyNow()" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>
                            class="text-white border-0 rounded-1 fs-14 fw-bold bg-black hov-opacity-70 has-transition py-20px px-20px w-100 mb-2 mb-md-0 mr-0 mr-md-2 buy-now"><?php echo e(translate('Buy Now')); ?>

                        </button>
                        <button type="button" id="added_to_cart_btn" <?php if(Auth::check() || get_Setting('guest_checkout_activation')==1): ?> onclick="addToCart()" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>
                            class="text-blue border-0 rounded-1 fs-14 fw-bold bg-soft-blue hov-bg-blue hov-text-white py-20px px-20px w-100 add-to-cart"><?php echo e(translate('Add to Cart')); ?> <span id="add_to_cart_count">(01)</span>
                        </button>
                ...
                <div class="d-flex align-items-center bg-light p-20px rounded-2 w-100 mb-2 mb-xl-0 mr-0 mr-xl-2">
                    ...
                    <div>
                        <?php if($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1): ?>
                            <p class="m-0 fs-14">
                                <span class="fw-400 text-gray"><?php echo e(translate('Sold by')); ?></span>
                                <a href="<?php echo e(route('shop.visit', $detailedProduct->user->shop->slug)); ?>" class="fw-bold text-blue pl-15px"><?php echo e($detailedProduct->user->shop->name); ?></a>
                            </p>
                        <?php else: ?>
                            <p class="m-0 fs-14">
                                <span class="fw-bold text-dark"><?php echo e(translate('Inhouse product')); ?></span>
                            </p>
                        <?php endif; ?>
                        <?php if(get_setting('conversation_system') == 1): ?>
                            <a href="javascript:void();" onclick="show_chat_modal()" class="fs-14 fw-400 text-blue animate-underline-blue has-transition"><?php echo e(translate('Message Seller')); ?></a>
            ...
            <div class="warranty-section pb-20px">
                <?php if($detailedProduct->has_warranty == 1 && $detailedProduct->warranty_id != null): ?>
                    <p class="fs-14 fw-bold text-dark mb-2"><?php echo e(translate('Warranty')); ?></p>
                    <div class="d-flex pb-20px border-bottom-dashed mb-2">
                        <div class="mr-4">
                            <p class="fs-14 fw-400 text-dark m-0"><?php echo e(translate('This Product has')); ?> <span class="fw-bold"> <?php echo e($detailedProduct->warranty->getTranslation('text')); ?></span> <?php echo e(translate('warranty')); ?></p>
                            <?php if($detailedProduct->warranty_note_id != null): ?>
                                <a href="javascript:void(1);" data-toggle="modal" data-target="#warranty-note-modal" class="fs-14 fw-400 text-blue m-0 animate-underline-blue has-transitio"><?php echo e(translate('View Details')); ?></a>
                            <?php endif; ?>
                        </div>
                        <div class="w-40px h-40px position-relative flex-shrink-0 overflow-hidden">
                            <img src="<?php echo e(uploaded_asset($detailedProduct->warranty->logo)); ?>" class="img-fluid position-absolute w-100 h-100" alt="Warranty Circle">
                        </div>
                    </div>
                <?php endif; ?>
                <ul class="m-0 p-0">
                    ...
                    <?php endif; ?>
                    <?php if(addon_is_activated('refund_request') && $detailedProduct->refundable == 1): ?>
                        <li class="d-flex align-items-center">
                            <span class="d-block flex-shrink-0">
                                <img src="<?php echo e(static_asset('/assets/img/warranty-check-circle.svg')); ?>" alt="warranty check circle">
                            </span>
                            <span class="d-block pl-10px pr-25px fs-14 fw-400 text-dark warranty-text"><?php echo e(translate('Refund Available for this producte')); ?></span>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="h-40px rounded-1 d-flex align-items-center justify-content-center overflow-hidden">
                                <?php if($refund_sticker != null): ?>
                                    <img src="<?php echo e(uploaded_asset($refund_sticker)); ?>" alt="cashback-gurantee-logo" class="img-fluid w-100 h-100">
                                <?php else: ?>
                                    <img src="<?php echo e(static_asset('/assets/img/cashback-gurantee-logo.svg')); ?>" alt="cashback-gurantee-logo" class="img-fluid w-100 h-100">
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
                    <div class="d-flex align-items-center flex-shrink-0">
                        <a href="javascript:void(1);" data-toggle="modal" data-target="#refund-note-modal" class="fs-14 fw-400 text-blue animate-underline-blue has-transition flex-shrink-0"><?php echo e(translate('View Notes')); ?></a>
                        <span class="fs-14 text-gray mx-2">|</span>
                        <a href="<?php echo e(route('returnpolicy')); ?>" target="_blank" class="fs-14 fw-400 text-blue animate-underline-blue has-transition flex-shrink-0"><?php echo e(translate('View Policy')); ?></a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="row no-gutters mb-3">
                <div class="col-12 col-sm-12 mt-3">
                    <div class="product-quantity d-flex align-items-center">
                        <a type="button" class="text-white text-center border-0 rounded-1 fs-14 fw-bold bg-black hov-opacity-70 has-transition py-20px px-20px d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2" href="<?php echo e($detailedProduct->external_link); ?>">
                ...
                <div class="col-12 col-sm-12 mt-3">
                    <div class="product-quantity d-flex align-items-center">
                        <button type="button" id="ref-cpurl-btn"
                            ...
                            data-url="<?php echo e($referral_code_url); ?>" class="text-white text-center border-0 rounded-1 fs-14 fw-bold btn btn-secondary has-transition d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2">
                            <?php echo e(translate('Copy the Promote Link')); ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
</div><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/product_details/details.blade.php ENDPATH**/ ?>