...
<?php $__env->startSection('panel_content'); ?>
    <div class="card shadow-none rounded-0 border">
        <div class="card-header border-bottom-0">
            <h5 class="mb-0 fs-20 fw-700 text-dark"><?php echo e(translate('Cancelled Delivery History')); ?></h5>
        </div>
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tbody class="fs-14">
                    <?php $__currentLoopData = $cancelled_deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="aiz-pagination mt-2">
                <?php echo e($cancelled_deliveries->appends(request()->input())->links()); ?>
...
<?php echo $__env->make('delivery_boys.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/delivery_boys/cancelled_delivery.blade.php ENDPATH**/ ?>