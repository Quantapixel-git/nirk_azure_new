<div
    ...
    <p class="fs-20 fw-bold text-dark"><?php echo e(translate('Frequently Bought Together')); ?></p>
    ...
    <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="6" data-xxl-items="6"
        ...
        <!--Single-->
        <?php $__empty_1 = true; $__currentLoopData = get_frequently_bought_products($detailedProduct); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $related_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="carousel-box">
            <div
                ...
                <a href="#" title="">
                    <img class="lazyload img-fit m-auto has-transition product-main-image"
                        ...
                        alt="<?php echo e($related_product->getTranslation('name')); ?>" onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>';">

                    <img class="lazyload img-fit m-auto has-transition product-main-image product-hover-image position-absolute"
                        src="<?php echo e(get_first_product_image($related_product->thumbnail, $related_product->photos)); ?>" alt="<?php echo e($related_product->getTranslation('name')); ?>"
            ...
            <div class="mt-2 pr-3">
                <h3 class="fw-400 fs-13 text-truncate-1 lh-1-4 mb-1">
                    <a href="<?php echo e(route('product', $related_product->slug)); ?>" class="text-reset hov-text-primary hov-text-primary"><?php echo e($related_product->getTranslation('name')); ?></a>
                </h3>
    ...
    <div class="text-center py-2 w-100">
        <h5 class="fs-16 fw-bold text-gray"><?php echo e(translate('No frequently bought products found!')); ?></h5>
        <span>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/product_details/frequently_bought_together.blade.php ENDPATH**/ ?>