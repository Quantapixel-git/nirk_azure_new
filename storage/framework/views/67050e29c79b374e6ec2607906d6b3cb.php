...
<?php $__env->startSection('panel_content'); ?>
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <?php if(addon_is_activated('gst_system') && !auth()->user()->shop->gst_verification): ?>
                <div class="col-md-12 alert alert-info text-center ">
                    <p class="font-weight-bold text-danger m-0"><?php echo e(translate('GST is being enabled on our platform. Please upload and complete the required documents from ')); ?> <a class="text-info" href="<?php echo e(route('seller.shop.index')); ?>"><?php echo e(translate('here')); ?></a>.  <?php echo e(translate('Products will not be published unless the form is completed and HSN codes and GST values are properly assigned.')); ?></p>
                </div>
            
            <?php else: ?>
            <div class="col-md-6">
                <h1 class="h3 text-primary"><?php echo e(translate('Dashboard')); ?></h1>
            </div>
            <?php endif; ?>
        </div>
    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                ...
                                <span class="fs-14 text-light"><?php echo e(translate('Products')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                <?php echo e(\App\Models\Product::where('user_id', $authUser->id)->count()); ?>
                     ...
                     <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-2 ml-1"><?php echo e(translate('Add New Product')); ?></p>
                        </div>
                        </a>
                     </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light"><?php echo e(translate('Rating')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                <?php echo e($authUser->shop?->rating); ?>
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <div class="d-flex align-items-center pt-1">
                            ...
                            <p class="fs-12 text-light my-2 ml-1"><?php echo e(translate('Followers').' '.$authUser->shop?->followers()->count()); ?></p>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-2 ml-1"><?php echo e(translate('Custom Followers').' '.$authUser->shop?->custom_followers); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light"><?php echo e(translate('Total Order')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                <?php echo e(\App\Models\Order::where('seller_id', $authUser->id)->where('delivery_status', 'delivered')->count()); ?>
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-2 ml-1"><?php echo e(translate('View All Order')); ?></p>
                        </div>
                        </a>
                     </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light"><?php echo e(translate('Total Sales')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                <?php
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <a href="<?php echo e(route('seller.orders.index')); ?>">
                        <div class="d-flex align-items-center">
                            <p class="fs-12 text-light my-2 ml-1"> <?php echo e(translate('Last Month')); ?>: <?php echo e(single_price($previous_month_sold_amount)); ?></p>
                        </div>
                        </a>
                     </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none bg-soft-primary">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        <?php echo e(translate('Sales Stat')); ?>
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        <?php echo e(translate('Sold Amount')); ?>

                    </div>
                    <p><?php echo e(translate('Your Sold Amount (Current month)')); ?></p>
                    <h3 class="text-primary fw-600 fs-30">
                        <?php echo e(single_price($this_month_sold_amount)); ?>

                    </h3>
                    <p class="mt-4">
                        <?php echo e(translate('Last Month')); ?>: <?php echo e(single_price($previous_month_sold_amount)); ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none h-450px mb-0 h-100">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        <?php echo e(translate('Category wise product count')); ?>
            ...
            <div class="card h-450px mb-0 h-100">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        ...
                        <p class="small text-muted mb-0">
                            <span class="fs-12 fw-600"><?php echo e(translate('This Month')); ?></span>
                        </p>
                    </div>
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600"><?php echo e(translate('New Order')); ?></span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e($this_month_pending_orders); ?>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600"><?php echo e(translate('Cancelled')); ?></span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e($this_month_cancelled_orders); ?>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600"><?php echo e(translate('On Delivery')); ?></span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e($this_month_on_the_way_orders); ?>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600"><?php echo e(translate('Delivered')); ?></span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                <?php echo e($this_month_delivered_orders); ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <?php if(addon_is_activated('seller_subscription')): ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if($authUser->shop?->seller_package): ?>
                            <div class="d-flex">
                                <div class="col-3">
                                    <img src="<?php echo e(uploaded_asset($authUser->shop->seller_package->logo)); ?>"
                                        class="img-fluid mb-4 w-64px">
                                </div>
                                <div class="col-9">
                                    <a class="fw-600 mb-3 text-primary"><?php echo e(translate('Current Package')); ?>:</a>
                                    <h6 class="text-primary">
                                        <?php echo e($authUser->shop->seller_package->name); ?>

                                        </h3>
                                        <p class="mb-1 text-muted"><?php echo e(translate('Product Upload Limit')); ?>:
                                            <?php echo e($authUser->shop->product_upload_limit); ?> <?php echo e(translate('Times')); ?>

                                        </p>
                                        <?php if(addon_is_activated('preorder')): ?>
                                            <p class="mb-1 text-muted"><?php echo e(translate('Preorder Product Upload Limit')); ?>:
                                                <?php echo e($authUser->shop->preorder_product_upload_limit); ?> <?php echo e(translate('Times')); ?>

                                            </p>
                                        <?php endif; ?>
                                        <p class="text-muted mb-4"><?php echo e(translate('Package Expires at')); ?>:
                                            <?php echo e($authUser->shop->package_invalid_at); ?>

                                        </p>
                                        <div class="">
                                            <a href="<?php echo e(route('seller.seller_packages_list')); ?>"
                                                class="btn btn-soft-primary"><?php echo e(translate('Upgrade Package')); ?></a>
                                        </div>
                                </div>
                            </div>
                        <?php else: ?>
            ...
            <?php endif; ?>
            <div
                class="card mb-0 <?php if(addon_is_activated('seller_subscription')): ?> px-4 py-5 <?php else: ?> p-5 h-100 <?php endif; ?> d-flex align-items-center justify-content-center">
                <?php if($authUser->shop?->verification_status == 0): ?>
                    <div class="my-n4 py-1 text-center">
                        <img src="<?php echo e(static_asset('assets/img/non_verified.png')); ?>" alt=""
                            class="w-xxl-130px w-90px d-block">
                        <a href="<?php echo e(route('seller.shop.verify')); ?>"
                            class="btn btn-sm btn-primary"><?php echo e(translate('Verify Now')); ?></a>
                    </div>
                <?php else: ?>
                    <div class="my-2 py-1">
                        <img src="<?php echo e(static_asset('assets/img/verified.png')); ?>" alt="" width="">
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="row">
      ...
      <?php if(get_setting('vendor_commission_activation') == 1): ?>
            <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
                <div class="card shadow-none h-450px mb-0 h-100">
                    <div class="card-body">
                        <div class="card-title text-primary fs-16 fw-600">
                            <?php echo e(translate('Commission Type & Rate')); ?>

                        </div>
                        <hr>
                        <ul class="list-group">
                            <?php if(get_setting('seller_commission_type') == 'fixed_rate'): ?>
                            <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                            <?php echo e(translate('You are Under Fixed Commission. Commission Rate')); ?>

                                <span class="">
                                    <?php echo e(get_setting('vendor_commission')); ?> %
                                </span>
                            </li>
                            <?php elseif(get_setting('seller_commission_type') == 'seller_based'): ?>
                            <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                            <?php echo e(translate('You are Under Seller Based Commission. Commission Rate')); ?>

                                <span class="">
                                    <?php echo e(\App\Models\Shop::where('user_id', $authUser->id)->first()->commission_percentage); ?> %
                                </span>
                            </li>
                            <?php elseif(get_setting('seller_commission_type') == 'category_based'): ?>
                            <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                             <?php echo e(translate('You are Under Category Wise Commission Rate ')); ?>

                                <span class="">
                                    <a class="btn btn-primary btn-xs " href="<?php echo e(route('seller.categories-wise-commission')); ?>" ><?php echo e(translate('Details')); ?></a>
                                </span>
                            </li>
                            <?php endif; ?>
                        </ul>
                ...
                <div class="card shadow-none h-450px mb-0 h-100">
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                             <?php echo e(translate('Currently No Commeision System is Set by Admin')); ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                ...
                <a href="<?php echo e(route('seller.shop.index')); ?>" class="btn btn-primary">
                    <?php echo e(translate('Go to setting')); ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                <div class="fs-16 fw-600 text-primary">
                    <?php echo e(translate('Payment Settings')); ?>
                ...
                <a href="<?php echo e(route('seller.profile.index')); ?>" class="btn btn-primary">
                    <?php echo e(translate('Configure Now')); ?>
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="<?php echo e(route('product', $product->slug)); ?>"
                                        class="d-block text-reset"><?php echo e($product->getTranslation('name')); ?></a>
                                </h3>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="varification_pending_modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content text-center p-4">
                ...
                <?php if($authUser->shop?->business_info == null || $authUser->shop?->business_info == ''): ?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fw-bold h6"><?php echo e(translate('Seller Verification')); ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                </div>
                <div class="modal-body c-scrollbar-light seller-verification-form">

                    <form action="<?php echo e(route('seller.shop.update')); ?>" method="POST" enctype="multipart/form-data" id="seller-verification-form">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="shop_id" value="<?php echo e(auth()->user()->shop->id); ?>">
                        <div class="form-group">
                            <label for="company-type" class="fs-13 fw-bold"><?php echo e(translate('Company Type (Dropdown Selection):')); ?></label>
                            <select
                            ...
                            <small id="type-error" class="text-danger d-none"> <?php echo e(translate('Please select a company type')); ?></small>
                        </div>


                        <div class="form-group">
                            <label for="certificate-number" class="fs-13 fw-bold"><?php echo e(translate('Licence Number')); ?></label>
                        ...
                        <div class="form-group">
                            <label for="tax-id-documents" class="fs-13 fw-bold"><?php echo e(translate('Tax Identification Document')); ?></label>
                            ...
                            <small id="certificate-error" class="text-danger d-none"> <?php echo e(translate('Please upload a valid certificate')); ?></small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small id="id_card-error" class="text-danger d-none"> <?php echo e(translate('Please upload a valid ID card')); ?></small>
                        </div>
                        ...
                        <div class="row">
                         ...
                         <div class="alert alert-danger d-none mb-4" id="photoSelfieRequiredAlert">
                            <?php echo e(translate('At least one of Photo or Live Selfie is required!')); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        AIZ.plugins.chart('#graph-1', {
            ...
            data: {
                labels: [
                    <?php $__currentLoopData = $last_7_days_sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $last_7_days_sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($key); ?>',
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
                datasets: [{
    ...
    <?php if(addon_is_activated('portfolio_system') && ($authUser->shop?->verification_status == 0)): ?>
    <script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/seller/dashboard.blade.php ENDPATH**/ ?>