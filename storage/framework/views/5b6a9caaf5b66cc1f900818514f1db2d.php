...
<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <!-- Product -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','add_digital_product','edit_digital_product','product_bulk_import',
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('products.all')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['digitalproducts.edit'])); ?>">
                    ...
                    <?php endif; ?>
                    <!--<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_digital_product')): ?>-->
                    <!--<li class="aiz-side-nav-item">-->
                    <!--    <a href="<?php echo e(route('digitalproducts.create')); ?>"-->
                    <!--        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['digitalproducts.create'])); ?>">-->
                    <!--        <span class="aiz-side-nav-text"><?php echo e(translate('Add New Digital Product')); ?></span>-->
                    <!--    </a>-->
                    <!--</li>-->
                    <!--<?php endif; ?>-->
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-3">
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('products.seller','all')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['products.seller.edit'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('All Products')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            <!--<li class="aiz-side-nav-item">-->
                            <!--    <a href="<?php echo e(route('products.seller','digital')); ?>" class="aiz-side-nav-link">-->
                        ...
                        <ul class="aiz-side-nav-list level-3">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('brands.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['brands.index', 'brands.create', 'brands.edit'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('All Brands')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('brand_bulk_upload.index')); ?>" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Brand Bulk Import')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_custom_label')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('custom_label.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['custom_label.edit', 'custom_label.create'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('attributes.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['attributes.index','attributes.create','attributes.edit','attributes.show'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('colors')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['colors','colors.edit','colors.create'])); ?>">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('smart-bar')): ?>
                    <li class="aiz-side-nav-item">
                        <a class="aiz-side-nav-link <?php echo e(areActiveRoutes(['smart.bar'])); ?>" href="<?php echo e(route('smart.bar')); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Smart Bar')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['preorder_dashboard', 'add_preorder_product', 'view_all_preorder_products', 'view_all_preorders', 'view_all_inhouse_preorders',
            ...
            <li class="aiz-side-nav-item">
                ...
                <!--Submenu-->
                <ul class="aiz-side-nav-list level-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('preorder_dashboard')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder.dashboard')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Dashboard')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_preorder_product')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder-product.create')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Add New Preorder products')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_products')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder-product.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder-product.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Products')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_preorders', 'view_all_inhouse_preorders', 'view_all_seller_preorders', 'view_all_delayed_prepayment_preorders', 'view_all_final_preorders'])): ?>
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            ...
                            ->where('request_preorder_time', '<', \Carbon\Carbon::now()->subDay())->count();
                                ...
                                ->where('prepayment_confirmation_time', '<', \Carbon\Carbon::now()->subDay())
                                    ...
                                    ->where('request_preorder_time', '<', \Carbon\Carbon::now()->subDay());
                                        ...
                                        ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorders')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('all_preorder.list')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder-order.show'])); ?> }}">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('All Orders')); ?> <span class="badge badge-info ml-1"><?php echo e($all_preorders_count ?: ''); ?></span> </span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_inhouse_preorders')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('inhouse_preorder.list')); ?>" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('Inhouse Orders')); ?> <span class="badge badge-info ml-1"><?php echo e($inhouse_preorders_count ?: ''); ?></span></span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_seller_preorders')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('seller_preorder.list')); ?>" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('Seller Orders')); ?> <span class="badge badge-info ml-1"><?php echo e($sellers_preorders_count ?: ''); ?></span></span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_delayed_prepayment_preorders')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('delayed_prepayment_preorders.list')); ?>" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('Delayed Prepayment')); ?> <span class="badge badge-info ml-1"><?php echo e($delayed_prepayment_preorders_count ?: ''); ?></span></span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_final_preorders')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('delayed_final_orders.list')); ?>" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('Delayed Final Orders')); ?> <span class="badge badge-info ml-1"><?php echo e($delayed_final_orders_count ?: ''); ?></span></span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                        </ul>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_preorder_seller_commission_history')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder-commission-history')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate("Preorder Commission History")); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('preorder_settings')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder-settings')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['faqs.create', 'faq.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate("Preorder Settings")); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_product_conversations')): ?>
                    <?php if(get_setting('conversation_system') == 1): ?>
                    <?php
                    $preorderConversation = get_non_viewed_preorder_conversations();
                    ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder-conversations.admin_index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder-conversations.admin_index','preorder-conversations.admin_show'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Product Conversation')); ?></span>
                    ...
                    <?php endif; ?>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_product_queries')): ?>
                    <?php if(get_setting('product_query_activation') == 1): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder.product_query.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder.product_query.index','preorder.product_query.show'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Product Queries')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_product_reviews')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder.product_reviews.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder.product_detail_reviews'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Product Reviews')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_faqs')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('faqs.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['faqs.create', 'faq.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate("FAQs")); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_notification_types')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('preorder-notification-types.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder.notification-type.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Notification Types')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('auction.all_products')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['auction_product_edit.admin','product_bids.admin'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('auction_products_orders')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['auction_products_orders.index'])); ?>">
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('wholesale_products.all')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wholesale_product_edit.admin'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('wholesale_products.in_house')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wholesale_product_edit.admin'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('wholesale_products.seller')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wholesale_product_edit.admin'])); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_refund_requests','view_approved_refund_requests','view_rejected_refund_requests','refund_request_configuration','set_category_wise_refund'])): ?>
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    <div class="aiz-side-nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('set_category_wise_refund')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('categories_wise_product_refund')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Category Based Refund')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <?php if(addon_is_activated('portfolio_system') && get_setting('customer_verification')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_customers')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('customers.unverified.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['customers.create'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Unverified Customers')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php endif; ?>
            ...
            <!-- Sellers -->
            <?php if(get_setting('vendor_system_activation') == 1): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_seller','seller_payment_history','view_seller_payout_requests','seller_commission_configuration','view_all_seller_packages','seller_verification_form_configuration','set_category_wise_commission','set_seller_based_commission'])): ?>
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    <div class="aiz-side-nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="<?php echo e(route('sellers.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['sellers.index', 'sellers.profile'])); ?>">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_pending_seller')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('sellers.registration_pending')); ?>"
                            class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Applied Seller')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('set_seller_based_commission')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('seller_based_commission')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Seller Based Commission')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('set_category_wise_commission')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('categories_wise_commission')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Category Based Commission')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('custom-alerts.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['custom-alerts.index', 'custom-alerts.create', 'custom-alerts.edit','custom-sale-alert.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Custom Alert')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_custom_sale_alert')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('custom-sale-alerts.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['custom-sale-alerts.index'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Custom Sell Alert')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('custom_visitors_setup')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('custom_product_visitors')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['custom_product_visitors'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Custom Visitors')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('otp.login_configuration')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('OTP Login Configuration')); ?></span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['manage_shipping_system'])): ?>
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    <div class="aiz-side-nav-icon">
                    ...
                    <span class="aiz-side-nav-text"><?php echo e(translate('Shipping System')); ?></span>
                    <?php if(env("DEMO_MODE") == "On"): ?>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.001" viewBox="0 0 16 14.001"
                        class="mx-2">
                        <path id="Union_49" data-name="Union 49"
                ...
                <ul class="aiz-side-nav-list level-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_shipping_system')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('shiprocket_configuration')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['shiprocket_configuration'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Shiprocket')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
                ...
                <ul class="aiz-side-nav-list level-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_shipping_system')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('steadfast_configuration')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['steadfast_configuration'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Steadfast')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
                ...
                <ul class="aiz-side-nav-list level-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_shipping_system')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('pathao_configuration')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['pathao_configuration'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Pathao')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('gst.unverified.sellers')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Unverified Sellers')); ?></span>
                        </a>
                    </li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('gst_assign')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('products.hsn-gst.assigns')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('HSN Assign')); ?></span>
                        </a>
                    </li>
                    <?php if(addon_is_activated('wholesale')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('products.wholesale-hsn-gst.assigns')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Wholesale Products')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(addon_is_activated('preorder')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('products.preorder-hsn-gst.assigns')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Products')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(addon_is_activated('auction')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('products.auction-hsn-gst.assigns')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Auction Products')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['payment_methods_configurations','african_pg_configuration','african_pg_credentials_configuration','view_all_manual_payment_methods','view_all_offline_payment_orders',
            ...
            <li class="aiz-side-nav-item">
                ...
                <a href="javascript:void(0);" class="aiz-side-nav-link">
                    ...
                    <span class="aiz-side-nav-text"><?php echo e(translate('Payment Gateways')); ?></span>
                    <span class="aiz-side-nav-arrow"></span>
                </a>
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <!-- Cybersource Addon -->
                    <?php if(addon_is_activated('cybersource') && auth()->user()->can('cybersource_pg_configuration')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('cybersource_configuration')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Cybersource Payment Gateway')); ?></span>
                            <?php if(env("DEMO_MODE") == "On"): ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.001" viewBox="0 0 16 14.001"
                                class="mx-2">
                                <path id="Union_49" data-name="Union 49"
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('african_credentials.index')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('African Payment Gateway')); ?></span>
                            <?php if(env("DEMO_MODE") == "On"): ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.001" viewBox="0 0 16 14.001"
                                class="mx-2">
                                <path id="Union_49" data-name="Union 49"
                    ...
                    <?php if(addon_is_activated('knet')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('knet_configuration')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('knet.configuration')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Knet Payment Gateway')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php endif; ?>
            ...
            <!-- Website Setup -->
            <!--<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance', 'authentication_layout_settings', 'top_banner_setting', 'view_top_banner'])): ?>-->
            <!--<li class="aiz-side-nav-item">-->
            <!--    <a href="#" class="aiz-side-nav-link <?php echo e((areActiveRoutes(['website.footer', 'website.header', 'website.pages', 'website.appearance']) && request('id') != 'portfolio' && request('page') != 'portfolio') ? 'active' : ''); ?>">-->
            <!--        <div class="aiz-side-nav-icon">-->
            ...
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.select-homepage')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['website.select-homepage'])); ?>">-->
            ...
            <!--                class="aiz-side-nav-link <?php echo e((request('id') == 'home' || request('page') == 'home') ? 'active' : ''); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Homepage Settings')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
            <!--        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('select_font_family')): ?>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.select-font-family')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['website.select-font-family'])); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Font Family')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
            <!--        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('authentication_layout_settings')): ?>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.authentication-layout-settings')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['website.authentication-layout-settings'])); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Authentication Layout & Settings')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
               
            <!--        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('select_header')): ?>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.select-header')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['website.select-header'])); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Select Header')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
            <!--        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('header_setup')): ?>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.header')); ?>" class="aiz-side-nav-link <?php echo e((Route::is('website.header') && request('id') != 'portfolio') ? 'active' : ''); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Header Settings')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
            <!--        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_top_banner'])): ?>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="#" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['top_banner.index', 'top_banner.setting', 'top_banner.create', 'top_banner.edit'])); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Top Bar')); ?></span>-->
            <!--                <span class="aiz-side-nav-arrow"></span>-->
            <!--            </a>-->
            <!--            Submenu-->
            <!--            <ul class="aiz-side-nav-list level-3">-->
            <!--                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_top_banner')): ?>-->
            <!--                <li class="aiz-side-nav-item">-->
            <!--                    <a class="aiz-side-nav-link <?php echo e(areActiveRoutes(['top_banner.index', 'top_banner.create', 'top_banner.edit'])); ?>" href="<?php echo e(route('top_banner.index')); ?>">-->
            <!--                        <span class="aiz-side-nav-text"><?php echo e(translate('Top Bar List')); ?></span>-->
            <!--                    </a>-->
            <!--                </li>-->
            <!--                <?php endif; ?>-->
            <!--                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('top_banner_setting')): ?>-->
            <!--                <li class="aiz-side-nav-item">-->
            <!--                    <a class="aiz-side-nav-link <?php echo e(areActiveRoutes(['top_banner.setting'])); ?>" href="<?php echo e(route('top_banner.setting')); ?>">-->
            <!--                        <span class="aiz-side-nav-text"><?php echo e(translate('Top Bar Settings')); ?></span>-->
            <!--                    </a>-->
            <!--                </li>-->
            <!--                <?php endif; ?>-->
            <!--            </ul>-->
            ...
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.footer', ['lang' => App::getLocale()])); ?>" class="aiz-side-nav-link <?php echo e((Route::is('website.footer') && request('id') != 'portfolio') ? 'active' : ''); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Footer Settings')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
            ...
            <!--                class="aiz-side-nav-link <?php echo e((areActiveRoutes(['website.pages', 'custom-pages.create', 'custom-pages.edit']) && request('id') != 'portfolio' && request('page') != 'portfolio') ? 'active' : ''); ?>">-->
            ...
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.appearance')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['website.appearance'])); ?>">-->
            ...
            <!--<?php if(addon_is_activated('portfolio_system')): ?>-->
            <!--<li class="aiz-side-nav-item">-->
            <!--    <a href="#" class="aiz-side-nav-link <?php echo e((request('id') == 'portfolio' || request('page') == 'portfolio' || Route::is('website.portfolioheader')) ? 'active' : ''); ?>">-->
            <!--        <div class="aiz-side-nav-icon">-->
            <!--            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">-->
            ...
            <!--            </svg>-->
            <!--        </div>-->
            <!--        <span class="aiz-side-nav-text"><?php echo e(translate('Landing Page Setup')); ?></span>-->
            <!--        <span class="aiz-side-nav-arrow"></span>-->
            <!--    </a>-->
            <!--    <ul class="aiz-side-nav-list level-2">-->

            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.portfolioheader')); ?>"-->
            <!--                class="aiz-side-nav-link">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Header Nav')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('custom-pages.edit', ['id' => 'portfolio', 'lang' => env('DEFAULT_LANGUAGE'), 'page' => 'portfolio'])); ?>"-->
            <!--                class="aiz-side-nav-link <?php echo e((request('id') == 'portfolio' || request('page') == 'portfolio') ? 'active' : ''); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Landing Page')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('footer_setup')): ?>-->
            <!--        <li class="aiz-side-nav-item">-->
            <!--            <a href="<?php echo e(route('website.footer', ['lang' => App::getLocale(), 'id' => 'portfolio'])); ?>" class="aiz-side-nav-link <?php echo e((Route::is('website.footer') && request('id') == 'portfolio') ? 'active' : ''); ?>">-->
            <!--                <span class="aiz-side-nav-text"><?php echo e(translate('Footer Settings')); ?></span>-->
            <!--            </a>-->
            <!--        </li>-->
            <!--        <?php endif; ?>-->
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('business_settings')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('business_settings.index')); ?>" class="aiz-side-nav-link">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('whatsapp_chat')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('whatsapp_chat.index')); ?>" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text"><?php echo e(translate('WhatsApp Chat')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['shipping_configuration','select_shipping_methods','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers', 'shipping_box_size_index', 'pickup_address_index'])): ?>
            <li class="aiz-side-nav-item">
                <a href="javascript:void(0);" class="aiz-side-nav-link">
                ...
                <ul class="aiz-side-nav-list level-3">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('select_shipping_methods')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('shipping_configuration.shipping_method')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['shipping_configuration.shipping_method'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Select Shipping Method')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_shipping_areas')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('areas.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['areas.index','areas.edit','areas.update'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Shipping Areas')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('zones.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['zones.index','zones.create','zones.edit'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('carriers.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['carriers.index','carriers.create','carriers.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Shipping Carrier')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(addon_is_activated('shiprocket')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pickup_address_index')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('pickup_address.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['pickup_address.index','pickup_address.create','pickup_address.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Pickup Addresses')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('shipping_box_size_index')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('shipping_box_size.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['shipping_box_size.index','shipping_box_size.create','shipping_box_size.edit'])); ?>">
                            <span class="aiz-side-nav-text"><?php echo e(translate('Shipping Box Size Configuration')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php endif; ?>
...
<li class="aiz-side-nav-item">
    ...
    <ul class="aiz-side-nav-list level-2">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sitemap_generator')): ?>
        <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('sitemap_generator')); ?>" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text"><?php echo e(translate('Sitemap Generator')); ?></span>
            </a>
        </li>
        <?php endif; ?>
...
<?php endif; ?> -->
    ...
    <a href="#" class="aiz-side-nav-link">
        <div class="aiz-side-nav-icon">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#575b6a" viewBox="0 0 16 16">
                <path d="M8 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM2 13a4 4 0 0 1 8 0H2zm10 0a3 3 0 0 1 2-2.83V13h-2zM13 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
            </svg>
        </div>

        <span class="aiz-side-nav-text">MLM System</span>
        <span class="aiz-side-nav-arrow"></span>
    </a>
    ...
    <ul class="aiz-side-nav-list level-2">
        ...
        <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('mlm.wallet.history')); ?>"
               class="aiz-side-nav-link <?php echo e(areActiveRoutes(['mlm.wallet.history'])); ?>">
                <span class="aiz-side-nav-text">MLM Wallet History</span>
            </a>
        </li>

        <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('mlm.user')); ?>"
               class="aiz-side-nav-link <?php echo e(areActiveRoutes(['mlm.user'])); ?>">
                <span class="aiz-side-nav-text">Manage MLM Users</span>
            </a>
        </li>
        
         <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('mlm.withdrawals')); ?>"
               class="aiz-side-nav-link <?php echo e(areActiveRoutes(['mlm.withdrawals'])); ?>">
                <span class="aiz-side-nav-text">Manage MLM Withdran Request</span>
            </a>
        </li>
            ...
            <li class="aiz-side-nav-item">
                <a href="<?php echo e(route('agent.targets')); ?>"
                    class="aiz-side-nav-link <?php echo e(areActiveRoutes(['agent.targets'])); ?>">
                    <div class="aiz-side-nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <g id="layer1" transform="translate(-0.53 -0.53)">
                                <path id="path3159"
                    ...
                    <span class="aiz-side-nav-text"><?php echo e(translate('Agent Target Configuration')); ?></span>
                </a>
            </li>
            <!-- Addon Manager -->
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>