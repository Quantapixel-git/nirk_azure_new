<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="p-4 text-center mb-4 border-bottom position-relative">
            ...
            <!-- Name -->
            <h4 class="h5 fs-14 mb-1 fw-700 text-dark"><?php echo e(Auth::user()->name); ?></h4>
            <!-- Phone -->
            <?php if(Auth::user()->phone != null): ?>
                <div class="text-truncate opacity-60 fs-12"><?php echo e(Auth::user()->phone); ?></div>
            <!-- Email -->
            <?php else: ?>
                <div class="text-truncate opacity-60 fs-12"><?php echo e(Auth::user()->email); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <!-- Assigned Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('assigned-deliveries')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['completed-delivery'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Assigned Delivery')); ?></span>
                    </a>
                </li>
                <!-- Pickup Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('pickup-deliveries')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['completed-delivery'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Picked Up Delivery')); ?></span>
                    </a>
                </li>
                <!-- On The Way Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('on-the-way-deliveries')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['completed-delivery'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('On The Way Delivery')); ?></span>
                    </a>
                </li>
                <!-- Pending Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('pending-deliveries')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['pending-delivery'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Pending Delivery')); ?></span>
                    </a>
                </li>
                <!-- Completed Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('completed-deliveries')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['completed-delivery'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Completed Delivery')); ?></span>
                    </a>
                </li>
                <!-- Cancelled Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('cancelled-deliveries')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['cancelled-delivery'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Cancelled Delivery')); ?></span>
                    </a>
                </li>
                <!-- Request to Cancel -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('cancel-request-list')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['cancel-request-list'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Request to Cancel')); ?></span>
                    </a>
                </li>
                <!-- Total Collections -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('total-collection')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['today-collection'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Total Collection')); ?></span>
                    </a>
                </li>
                <!-- Total Earnings -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('total-earnings')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['total-earnings'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Earnings')); ?></span>
                    </a>
                </li>
                <!-- Manage Profile -->
                <li class="aiz-side-nav-item">
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/delivery_boys/inc/delivery_boy_sidenav.blade.php ENDPATH**/ ?>