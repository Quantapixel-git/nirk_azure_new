                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img src="<?php echo e(uploaded_asset(get_setting('delivery_boy_login_page_image'))); ?>" alt="<?php echo e(translate('Customer Login Page Image')); ?>" class="img-fit h-100">
                            </div>
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 border right-content">
                                ...
                                <div class="text-center text-lg-left">
                                    ...
                                    <h5 class="fs-14 fw-400 text-dark"><?php echo e(translate('Login to your delivery boy account')); ?></h5>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layouts.authentication', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/auth/boxed/deliveryboy_login.blade.php ENDPATH**/ ?>