<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    ...
    <span class="avatar avatar-md mb-3">
        <?php if($user->avatar_original != null): ?>
            <img src="<?php echo e($user_avatar); ?>"
    ...
    <!-- Name -->
    <h4 class="h5 fs-14 mb-1 fw-700 text-dark"><?php echo e($user->name); ?></h4>

    <!-- Phone -->
    <?php if(!empty($user->phone)): ?>
        <div class="text-truncate opacity-60 fs-12"><?php echo e($user->phone); ?></div>
    <?php endif; ?>

    <!-- Email (ALWAYS SHOW IF EXISTS) -->
    <?php if(!empty($user->email)): ?>
        <div class="text-truncate opacity-60 fs-12"><?php echo e($user->email); ?></div>
    <?php endif; ?>

    <!-- Referral Code + Copy Button (INLINE) -->
   <?php if(!empty($user->referral_code)): ?>

<?php
    $referralLink = url('https://nirk.dialfirst.in/users/registration?referral_code=' . $user->referral_code);
?>

<div class="mt-2 d-flex justify-content-center align-items-center">

    <!-- REFERRAL CODE -->
    <span class="text-truncate opacity-60 fs-12" id="refCode">
    ...
    <button class="copy-btn ml-2"
        ...
        <img src="<?php echo e(asset('public/assets/img/copy.png')); ?>"
             alt="Copy"
             width="8">
    ...
    <!-- SHARE BUTTON -->
    <button class="copy-btn ml-2"
            onclick="shareReferralLink('<?php echo e($referralLink); ?>')"
            title="Share Referral Link">

        <img src="<?php echo e(asset('public/assets/img/share.png')); ?>"
             alt="Share"
             width="7">
            ...
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('dashboard')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['dashboard'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Dashboard')); ?></span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('purchase_history.index')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['purchase_history.index', 'purchase_history.details'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Purchase History')); ?></span>
                ...
                <li class="aiz-side-nav-item">
    <a href="<?php echo e(route('mlm.userwallet')); ?>"
        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['mlm.userwallet'])); ?>">

        <!-- ICON (you can change if needed) -->
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
            <g fill="#b5b5bf">
                <path d="M2 4h12a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H2z"/>
                <path d="M11 8h3v2h-3a1 1 0 0 1 0-2z"/>
            </g>
        </svg>

        <!-- TEXT -->
        <span class="aiz-side-nav-text ml-3">
            <?php echo e(translate('My Wallet')); ?>
                ...
                <?php if(addon_is_activated('preorder')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Preorder')); ?></span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('preorder.order_list')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder.order_list', 'purchase_history.details'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Preorder List')); ?></span>
                                </a>
                            </li>
                            <?php if(get_setting('conversation_system') == 1): ?> 
                                ...
                                ?>    
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('preorder-conversations.customer-index')); ?>"
                                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder-conversations.customer-show'])); ?>">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Conversations')); ?></span>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('digital_purchase_history.index')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['digital_purchase_history.index'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Downloads')); ?></span>
                    </a>
                </li>
                ...
                <?php if(addon_is_activated('refund_request')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('customer_refund_request')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['customer_refund_request'])); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Refund Requests')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('wishlists.index')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wishlists.index'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Wishlist')); ?></span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('compare')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['compare'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Compare')); ?></span>
                    </a>
                </li>
                ...
                <!-- Followed Sellers -->
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('followed_seller')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['followed_seller'])); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Followed Sellers')); ?></span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <?php if(get_setting('classified_product') == 1): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('customer_products.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['customer_products.index', 'customer_products.create', 'customer_products.edit'])); ?>">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Classified Products')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(addon_is_activated('auction')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Auction')); ?></span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                ...
                <?php if(get_setting('conversation_system') == 1): ?>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('conversations.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['conversations.index', 'conversations.show'])); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Conversations')); ?></span>
                ...
                <?php if(get_setting('wallet_system') == 1): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('wallet.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wallet.index'])); ?>">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('My Wallet')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(addon_is_activated('club_point')): ?>
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('earnng_point_for_user')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['earnng_point_for_user'])); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Earning Points')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(addon_is_activated('affiliate_system') &&
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Affiliate')); ?></span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('affiliate.user.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['affiliate.user.index','affiliate.payment_settings'])); ?>">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Affiliate System')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('affiliate.user.payment_history')); ?>"
                                    class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Payment History')); ?></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('affiliate.user.withdraw_request_history')); ?>"
                                    class="aiz-side-nav-link">
                                    <span
                                        class="aiz-side-nav-text"><?php echo e(translate('Withdraw request history')); ?></span>
                                </a>
                            </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('support_ticket.index')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['support_ticket.index', 'support_ticket.show'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Support Ticket')); ?></span>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('profile')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['profile'])); ?>">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Manage Profile')); ?></span>
                    </a>
                </li>

                <!-- Delete My Account -->
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0)" onclick="account_delete_confirm_modal('<?php echo e(route('account_delete')); ?>')" class="aiz-side-nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3"><?php echo e(translate('Delete My Account')); ?></span>
                    </a>
                </li>
            ...
            <!-- logout -->
            <a href="<?php echo e(route('logout')); ?>" class="btn btn-primary btn-block fs-14 fw-700 mb-5 mb-md-0" style="border-radius: 25px;"><?php echo e(translate('Sign Out')); ?></a>
        </div>
...
</script><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/inc/user_side_nav.blade.php ENDPATH**/ ?>