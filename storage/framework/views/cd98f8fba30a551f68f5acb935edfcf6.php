...
<?php $__env->startSection('panel_content'); ?>
    <div class="card shadow-none rounded-0 border">
        <div class="card-header border-bottom-0">
            <h5 class="mb-0 fs-20 fw-700 text-dark"><?php echo e(translate('Pending Delivery History')); ?></h5>
        </div>
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tbody class="fs-14">
                    <?php $__currentLoopData = $pending_deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($order->orderDetails) > 0): ?>
                            <tr>
                                <!-- Code -->
                                <td class="pl-0" style="vertical-align: middle;">
                                    <a href="<?php echo e(route('delivery-boy.order-detail', encrypt($order->id))); ?>"><?php echo e($order->code); ?></a>
                                </td>
                                <!-- Date -->
                                ...
                                <td class="text-right pr-0" style="vertical-align: middle;">
                                    <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm" onclick="confirm_cancel_request('<?php echo e(route('cancel-request', $order->id)); ?>')" title="<?php echo e(translate('Cancel')); ?>">
                                        <i class="las la-times"></i>
                                    </a>
                                    <a href="<?php echo e(route('delivery-boy.order-detail', encrypt($order->id))); ?>" class="btn btn-soft-info btn-icon btn-circle btn-sm hov-svg-white" title="<?php echo e(translate('Order Details')); ?>">
            ...
            <div class="aiz-paginationn mt-2">
                <?php echo e($pending_deliveries->appends(request()->input())->links()); ?>
...
<?php echo $__env->make('delivery_boys.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/delivery_boys/pending_delivery.blade.php ENDPATH**/ ?>