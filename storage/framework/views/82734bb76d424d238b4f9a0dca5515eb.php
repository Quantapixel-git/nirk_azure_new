            ...
            <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                <div class="card shadow-none rounded-0 border-0">
                    <div class="row no-gutters">
                        <!-- Left Side Image-->
                        <!-- <div class="col-lg-6">
                            <img src="<?php echo e(uploaded_asset(get_setting('admin_login_page_image'))); ?>" alt="<?php echo e(translate('Admin Login Page Image')); ?>" class="img-fit h-100">
                        </div> -->
                         ...
                         <div class="col-12 col-md-8 col-lg-6 mx-auto p-4 p-lg-5 d-flex flex-column justify-content-center border rounded shadow-sm right-content">
                            <!-- Site Icon -->
                            <div class="size-48px mb-3 mx-auto mx-lg-0 mobile-top-space">
                            ...
                            <div class="pt-3">
                                <div class="">
                                    <form class="form-default" id="login-form" role="form" action="<?php echo e(route('login')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button class="btn btn-info btn-xs" onclick="autoFillAdmin()"><?php echo e(translate('Copy')); ?></button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/auth/boxed/admin_login.blade.php ENDPATH**/ ?>