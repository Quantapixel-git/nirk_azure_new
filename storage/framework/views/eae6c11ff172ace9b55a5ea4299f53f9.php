<script type="text/javascript">
    function sendVerificationCode(clickedBtn = null) {
        let recaptchaEnabled = <?php echo e(get_setting('google_recaptcha') == 1 && get_setting('recaptcha_customer_register') == 1 ? 'true' : 'false'); ?>;
        ...
        if (!identifier) {
            AIZ.plugins.notify('danger', '<?php echo e(translate("Please enter your email or phone number")); ?>');
            return;
        }
        ...
        function ajaxSend(data) {
            $.post('<?php echo e(route("customer-reg.verification_code_send")); ?>', data, function (res) {
    ...
    codeInput.addEventListener('input', function() {
        ...
        if (this.value.length === 6) {
            ...
            let country_code = $('input[name="country_code"]').val()?? '';
            let identifier = email ? email : phone;
            $.post('<?php echo e(route("customer-reg.verify_code_confirmation")); ?>', {
                _token: '<?php echo e(csrf_token()); ?>',
...
</script><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/auth/verifyEmailOrPhone.blade.php ENDPATH**/ ?>