<!-- New Address Modal -->
<div class="modal fade" id="new-billing-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(translate('New Billing Address')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-default" role="form" action="<?php echo e(route('billing_addresses.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <input type="hidden" name="country_id" value="<?php echo e(get_active_countries()[0]->id); ?>">
                        <?php endif; ?>
                        ...
                        <div class="row area-field d-none">
                            <div class="col-md-2">
                                <label><?php echo e(translate('Area')); ?></label>
                            </div>
                            <div class="col-md-10">
...
<div class="modal fade" id="edit-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(translate('Edit Address')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
</div><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/partials/address/billing_address_modal.blade.php ENDPATH**/ ?>