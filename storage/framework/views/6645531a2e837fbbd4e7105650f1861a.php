   ...
   <script type="text/javascript">
        ...
        function getReviews(seemore= false, rating = null) {
            ...
            $.ajax({
                ...
                method: 'GET',
                data: { slug: '<?php echo e($detailedProduct->slug); ?>', limit: limit, sort_by: sortBy, rating: rating },
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/product_details.blade.php ENDPATH**/ ?>