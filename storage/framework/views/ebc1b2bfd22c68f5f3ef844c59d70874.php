...
<?php $__env->startSection('content'); ?>
    ...
    <ul class="nav nav-tabs nav-fill language-bar">
        <?php $__currentLoopData = get_all_active_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="nav-item">
                <a class="nav-link text-reset <?php if($language->code == $lang): ?> active <?php endif; ?> py-3" href="<?php echo e(route('website.footer', ['lang'=> $language->code] )); ?>">
    					...
    					<div class="card-body">
    						<form action="<?php echo e(route('business_settings.update')); ?>" method="POST" enctype="multipart/form-data">
    							...
    							<div class="form-group">
                                    ...
                                    <small class="text-muted"><?php echo e(translate("Minimum dimensions required: 275px width X 44px height.")); ?></small>
    			                </div>
								<!-- About description -->
    			                <div class="form-group">
                ...
                <div class="card shadow-none bg-light">
					...
					<div class="card-body">
						<div class="form-group">
                            ...
                            <small class="text-muted"><?php echo e(translate("Minimum dimensions required: 144px width X 20px height.")); ?></small>
						</div>
					</div>
                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/backend/website_settings/footer.blade.php ENDPATH**/ ?>