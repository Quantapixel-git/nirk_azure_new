                    ...
                    <div class="dropdown mb-2 mb-md-0 bg-light mt-2 mt-md-0 px-md-1 rounded-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item confirm-alert text-secondary fs-14 fw-500 hov-bg-light hov-text-blue"
                                href="javascript:void(0)" href="javascript:void(0)" onclick="order_bulk_export()"><?php echo e(translate('Export')); ?></a>
                        </div>
                    </div>
                    <!--Filter-->
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        function getOrders( page = 1) {
            ...
            $.ajax({
                url: `<?php echo e(route('seller.orders.filter' )); ?>?page=${page}`,
                method: 'GET',
       ...
       function order_bulk_export (){
            var url = '<?php echo e(route('seller.order-bulk-export')); ?>';
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/seller/orders/index.blade.php ENDPATH**/ ?>