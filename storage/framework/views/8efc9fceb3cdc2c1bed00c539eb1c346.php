...
<a href="javascript:void(0)" class="d-flex align-items-center <?php if(get_setting('header_element') !=6): ?> px-3 <?php endif; ?> h-100" data-toggle="dropdown" data-display="static"
    title="<?php echo e(translate('Cart')); ?>">
    <?php if(get_setting('header_element') != 6): ?>
        <span class="mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20.562" viewBox="0 0 24 20.562"
                class="<?php echo e(get_setting('header_element') !=5 ? 'bottom-text-color-visibility' : 'middle-text-color-visibility'); ?>"
                style="color: <?php echo e(get_setting('header_element') !=5 ? get_setting('bottom_header_text_color'): get_setting('middle_header_text_color')); ?>">
        ...
        <span class="d-none d-xl-block ml-2 fs-14 fw-700 <?php echo e(get_setting('header_element') !=5 ? 'bottom-text-color-visibility' : 'middle-text-color-visibility'); ?>"
            style="color: <?php echo e(get_setting('header_element') !=5 ? get_setting('bottom_header_text_color'): get_setting('middle_header_text_color')); ?>"><?php echo e(single_price($total)); ?></span>
        <span class="nav-box-text d-none d-xl-block ml-2 fs-12 <?php echo e(get_setting('header_element') !=5 ? 'bottom-text-color-visibility' : 'middle-text-color-visibility'); ?>"
            style="color: <?php echo e(get_setting('header_element') !=5 ? get_setting('bottom_header_text_color'): get_setting('middle_header_text_color')); ?>">

            (<span class="cart-count"><?php echo e(count($carts) > 0 ? count($carts) : 0); ?></span> <?php echo e(translate('Items')); ?>)
    ...
    <?php else: ?>  
        <span class="mr-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                style="color: <?php echo e(get_setting('bottom_header_text_color')); ?>"
        ...
        <span class="d-none d-xl-block ml-1 fs-14 fw-700 bottom-text-color-visibility"
            style="color: <?php echo e(get_setting('bottom_header_text_color')); ?>"><?php echo e(translate('Cart')); ?></span>
                        ...
                        <span class="d-flex align-items-center">
                            <a href="<?php echo e(route('product', $product->slug)); ?>"
                                ...
                                <img src="<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>"
                                    ...
                                    class="img-fit lazyload size-60px has-transition" alt="<?php echo e($product->getTranslation('name')); ?>"
...
<?php /**PATH /home/u635947223/domains/dialfirst.in/public_html/nirk/resources/views/frontend/partials/cart/cart.blade.php ENDPATH**/ ?>