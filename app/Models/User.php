...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'address', 'city', 'postal_code', 'phone', 'country', 'provider_id', 'email_verified_at', 'verification_code', 'verification_status','referred_by',  'referral_code', 'user_type','recent_order_date','action_date','mlm_status','mlm_blocked_at','is_active' // add this
    ];
