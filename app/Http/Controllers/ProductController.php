...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        $seller_type = 'admin';
        $product_types = ['All Products', 'Physical Products',  'Drafts'];
    ...
    public function seller_products(Request $request, $product_type)
    {
        ...
        if ($product_type === 'physical') {
            ...
            $product_types = ['All Seller Products', 'Physical Products'];
        }
    ...
    public function all_products(Request $request)
    {
        ...
        if ($request->has('brand_id') && $request->brand_id != null) {
            ...
            $product_types = ['All Products', 'Inhouse Products', 'Seller Products', 'Physical Products', 'Drafts'];
        }
...
ProductMLMPrize::create([

    'product_id'   => $product->id,

    'is_return'    => $request->has('is_return') ? 1 : 2,
    ...
    'coins'        => $request->coins,
     'mlm_percentage' => $request->mlm_percentage,
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $mlm = ProductMLMPrize::where('product_id', $product->id)->first();
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        $type = 'In House';
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'type', 'mlm'));
    }
...
ProductMLMPrize::updateOrCreate(
