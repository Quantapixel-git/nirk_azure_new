...
class ProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        // MLM Fields
        $rules['level0'] = 'nullable|numeric';
        $rules['level1'] = 'nullable|numeric';
        $rules['level2'] = 'nullable|numeric';
        $rules['level3'] = 'nullable|numeric';
        $rules['level4'] = 'nullable|numeric';
        $rules['level5'] = 'nullable|numeric';
        $rules['level6'] = 'nullable|numeric';
